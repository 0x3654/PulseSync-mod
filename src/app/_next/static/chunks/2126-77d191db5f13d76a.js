...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2126],
    {
            ...
            class n extends i.Y {
                ...
                createRequestHeadersFromParams(t) {
                    ...
                    let b = (null == t || null == (e = t.common) ? void 0 : e.oauth) || this.config.params.common.oauth,
                        ...
                        S = null == (E = null == t || null == (d = t.common) ? void 0 : d.withoutInvocationInfo) || E,
                        ...
                        D = (null == t || null == (m = t.common) ? void 0 : m.clientIp) || this.config.params.common.clientIp,
                        O = (null == t || null == (v = t.common) ? void 0 : v.tracestate) || this.config.params.common.tracestate,
                    ...
                    return (
                        ...
                        S && (L['x-yandex-music-without-invocation-info'] = '1'),
        ...
        42464: (t, e, r) => {
            r.d(e, { N: () => a });
            let a = (t) => 'object' == typeof t && null !== t && 'request' in t && null !== t.request;
        },
        44547: (t, e, r) => {
            r.d(e, {
                wV: () => t8,
            ...
            let h = Symbol('CONTAINER_USER_CONFIG_TOKEN'),
                ...
                S = Symbol('CONTAINER_HOOKS_TOKEN'),
                ...
                async getImage(t, e) {
                    try {
                        let r = (0, ty.createAvatarUrl)(t, this.variables.coverSize, !1),
                            a = await fetch(r, { cache: 'no-store', headers: { Accept: 'image/webp, */*' } }),
                            i = await a.blob();
                        e(i);
                    } catch (e) {
                        ...
                        ? Promise.all(
                              r.map(async (e) => {
                                  ...
                                  0 === (await (null == (a = this.repositoryContainer.artistsTracksRepository) ? void 0 : a.getCountByArtist(s))))
                                      ? Promise.all([
                                            null == (i = this.fileStorage) ? void 0 : i.deleteFile(O(s)),
            ...
            class t2 extends tP {
                ...
                async get(t, e) {
                    return this.executeTransaction(async (r) => {
                        let a = await r.get(q.name, t4(t, e));
                        return null != a ? a : null;
                    }).catch((r) => {
                ...
                async delete(t, e) {
                    return this.executeTransaction(async (r) => r.delete(q.name, t4(t, e))).catch((r) => {
            ...
            class t3 extends tP {
                ...
                async get(t, e) {
                    return this.executeTransaction(async (r) => {
                        let a = await r.get(V.name, t6(t, e));
                        return null != a ? a : null;
                    }).catch((r) => {
                ...
                async delete(t, e) {
                    return this.executeTransaction(async (r) => r.delete(V.name, t6(t, e))).catch((r) => {
                    ...
                    (this.container ||
                        (this.container = (function (t) {
                            ...
                            return new te.Dt().registerMany({
                                ...
                                [f]: (0, te.do)((t) => new tS({ container: t })),
                                [T]: (0, te.Gr)((t) => {
                        ...
                        (this.repositoryContainer = ((t) => {
                            ...
                            return (
                                ...
                                a &&
                                    ...
                                    (i.usersTracksRepository = new t3()),
                                    (i.usersAlbumsRepository = new t2())),
                                i
                            );
                        })(t)),
        ...
        78648: (t, e, r) => {
            ...
            let n = (t) => {
                ...
                s = (t) => (t.uid ? 'authorized' : 'no-uid'),
                o = (t) => {
                    if (!(t instanceof a.m5) || !(0, i.N)(t.cause)) return 'unexpected';
                    let e = ((t) => {
                        if (!(0, i.N)(t.cause)) return;
