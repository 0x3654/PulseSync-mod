                        ...
                        (t.prototype.onChange = function (t, e) {
                            ...
                            return (
                                ...
                                this.observableValue.subscribe(function (o) {
                                    if (o !== r.prevValueByListener.get(t)) {
                                        if (e.skipFirstChange && n) {
                                            n = !1;
                                            return;
                                        }
                                        (r.prevValueByListener.set(t, o), t(o));
                                    }
                                })
                            );
                        }),
...
`,
        ...
        90153: (t, e, r) => {
            ((e.w5 = function (t, e) {
                let {
                        skeletonId: r = '',
                        mainObjectType: s = o.DomainObjectType.NonApplicable,
                        mainObjectId: i = '',
                        tabId: a = '',
                        tabPos: l = 0,
                    ...
                    h = (0, n.makeMetaParams)(1),
                    u = { ...e, skeletonId: r, mainObjectType: s, mainObjectId: i, tabId: a, tabPos: l, isTabSelectedByDefault: c, viewUuid: p, _meta: h };
                t.trackEvent('Screen.Opened', u);
            }),
                (e.Fn = function (t, e) {
                    let {
                            pageStyle: r = o.PageStyles.Fullscreen,
                            pagePlacement: s = o.PagePlacements.Fullscreen,
                            skeletonId: i = '',
                            mainObjectType: a = o.DomainObjectType.NonApplicable,
                            mainObjectId: l = '',
                            tabId: c = '',
                            tabPos: p = 0,
                            isTabSelectedByDefault: h = !1,
                            viewUuid: u = '',
                        } = e,
                        ...
                        v = {
                            ...
                            tabId: c,
                            tabPos: p,
                            isTabSelectedByDefault: h,
                            viewUuid: u,
                            _meta: f,
                        };
                    t.trackEvent('Screen.Opened', v);
                }),
                (e.XB = function (t, e) {
                    let {
                            skeletonId: r = '',
                        ...
                        h = { ...e, skeletonId: r, mainObjectType: s, mainObjectId: i, tabId: a, tabPos: l, isTabSelectedByDefault: c, _meta: p };
                    t.trackEvent('Screen.Closed', h);
                }),
                (e.Ig = function (t, e) {
                    let {
                            pageStyle: r = o.PageStyles.Fullscreen,
                ...
                (e.Mu = function (t, e) {
                    let {
                        ...
                        p = (0, n.makeMetaParams)(1),
                        h = { ...e, skeletonId: r, mainObjectType: s, mainObjectId: i, tabId: a, tabPos: l, isTabSelectedByDefault: c, _meta: p };
                    t.trackEvent('Screen.Navigated', h);
                }),
                (e.ID = function (t, e) {
                    let {
                            pageStyle: r = o.PageStyles.Fullscreen,
                    ...
                    t.trackEvent('Screen.Navigated', v);
                }),
                (e.bv = function (t, e) {
                    let {
                            skeletonId: r = '',
                        ...
                        p = (0, n.makeMetaParams)(1),
                        h = { ...e, skeletonId: r, mainObjectType: s, mainObjectId: i, tabId: a, tabPos: l, isTabSelectedByDefault: c, _meta: p };
                    t.trackEvent('Screen.ActionPerformed', h);
                }),
                (e.z5 = function (t, e) {
                    let {
                            pageStyle: r = o.PageStyles.Fullscreen,
                        ...
                        p = { ...e, pageStyle: r, pagePlacement: s, skeletonId: i, mainObjectType: a, mainObjectId: l, _meta: c };
                    t.trackEvent('Screen.ErrorRaised', p);
                }));
            let n = r(92871),
                o = r(99923);
        },
        98411: (t, e, r) => {
            ...
            function b(t) {
                ...
                (y(this), (i = t), (this.f &= -2), 8 & this.f && $(this), o());
            }
            function k(t) {
            ...
            ((u.prototype.h = function () {
                ...
                ((_.prototype = new u()).h = function () {
                    if (((this.f &= -3), 1 & this.f)) return !1;
                    if (32 == (36 & this.f) || ((this.f &= -5), this.g === p)) return !0;
                    if (((this.g = p), (this.f |= 1), this.i > 0 && !v(this))) return ((this.f &= -2), !0);
                    var t = i;
                    try {
                        (d(this), (i = this));
                        var e = this.x();
                ...
                (k.prototype.S = function () {
                    (1 & this.f && n(), (this.f |= 1), (this.f &= -9), g(this), d(this), l++);
                    var t = i;
                    return ((i = this), b.bind(this, t));
                }),
