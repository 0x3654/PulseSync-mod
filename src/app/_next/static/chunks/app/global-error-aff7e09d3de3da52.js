(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [4219],
    {
        ...
        52803: (e, t, r) => {
            ...
            let c = function (e, t, r, c) {
                ...
                for (var l = -1, u = t.length, d = u - 1, f = e; null != f && ++l < u;) {
                    ...
                    if (l != d) {
                        var A = f[h];
                        void 0 === (v = c ? c(A, h, f) : void 0) && (v = (0, i.A)(A) ? A : (0, n.A)(t[l + 1]) ? [] : {});
                    }
                    ((0, o.A)(f, h, v), (f = f[h]));
                }
                return e;
        ...
        55379: (e, t, r) => {
            Promise.resolve().then(r.bind(r, 91477));
        },
        60058: (e, t, r) => {
            'use strict';
            r.d(t, { A: () => d });
        ...
        62385: (e, t, r) => {
            'use strict';
            r.d(t, { A: () => o });
            let o = 'object' == typeof global && global && global.Object === Object && global;
        },
        62850: (e, t, r) => {
            'use strict';
            r.d(t, { r: () => n });
        ...
        64450: (e, t, r) => {
            ...
            class c {
                ...
                formatMessage(e, t, r = {}, s) {
                    ...
                    return (Object.keys(c).length && (n = this.obfuscateData(c)), s) ? `${a} ${o(n)}` : [a, n];
                }
                obfuscateData(e) {
        ...
        75492: (e, t, r) => {
            ...
            let n = o.A || s || Function('return this')();
        },
        77769: (e, t) => {
        ...
        86867: (e, t, r) => {
            ...
            var o = r(60058),
                s = r(83107);
            let n = function (e) {
                return 'symbol' == typeof e || ((0, s.A)(e) && '[object Symbol]' == (0, o.A)(e));
            };
        },
        87505: (e, t, r) => {
            'use strict';
        ...
        91477: (e, t, r) => {
            ...
            r(12818);
            var c = r(49124);
            let l = new i.r({ maxLogLevel: n.cm.DEBUG, secureFields: a.x, disableLogToConsole: !0 });
            function u(e) {
                let { error: t } = e,
                    r = c.env.ASSET_PREFIX || '';
                return (
                    (0, s.useEffect)(() => {
                        l.error('[Desktop application fatal error] '.concat(t.message), { additional: t, type: 'error-boundary' });
                    }, [t]),
                    (0, o.jsxs)('html', {
                        children: [
                            (0, o.jsxs)('head', {
                                children: [
                                    (0, o.jsx)('link', {
                                        rel: 'preload',
                                        as: 'font',
                                        href: ''.concat(r, '/fonts/YSText-Regular.woff2'),
                                        type: 'font/woff2',
                                        crossOrigin: '',
                                    }),
                                    (0, o.jsx)('link', {
                                        rel: 'preload',
                                        as: 'font',
                                        href: ''.concat(r, '/fonts/YSText-Medium.woff2'),
                                        type: 'font/woff2',
                                        crossOrigin: '',
                                    }),
                                    (0, o.jsx)('link', {
                                        rel: 'preload',
                                        as: 'font',
                                        href: ''.concat(r, '/fonts/YSText-Bold.woff2'),
                                        type: 'font/woff2',
                                        crossOrigin: '',
                                    }),
                                    (0, o.jsx)('link', {
                                        rel: 'preload',
                                        as: 'font',
                                        href: ''.concat(r, '/fonts/YSMusic-HeadlineBold.woff2'),
                                        type: 'font/woff2',
                                        crossOrigin: '',
                                    }),
                                    (0, o.jsx)('link', { rel: 'stylesheet', href: ''.concat(r, '/styles/fonts.css') }),
                                ],
                            }),
                            (0, o.jsx)('body', {
    ...
    (e) => {
        (e.O(0, [8153, 7182, 2497, 2536, 4220, 9562, 7358], () => e((e.s = 55379))), (_N_E = e.O()));
    },
]);
