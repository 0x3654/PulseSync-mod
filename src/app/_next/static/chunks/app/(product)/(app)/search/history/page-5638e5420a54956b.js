(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5160],
    {
            ...
            let v = (e) => {
                ...
                h = (e) => {
                    ...
                    return (0, s.useCallback)(async () => {
                        if (!e) return;
                        if (!t.isAuthorized)
                            return void i((0, r.jsx)(u.h, { error: _({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: l.u.ERROR });
                        if (m) return;
                        ...
                        (p(!1),
                            n === o.f.OK
                                ? i((0, r.jsx)(v, { artist: s }), { containerId: l.u.INFO })
                                : i((0, r.jsx)(u.h, { error: _({ id: 'error-messages.error-during-action' }) }), { containerId: l.u.ERROR }));
            ...
            let L = (0, s.PA)((e) => {
                ...
                w = (0, s.PA)((e) => {
                    ...
                    let {
                        ...
                        q = (0, x.P)(),
                        X = (0, v.K)(h),
                        Z = (0, y.P)(Math.round((null != (i = h.durationMs) ? i : 0) / 1e3)),
                        J = (0, g.F)(),
                        Q = H.hasPlus,
                        ee = !h.isRemoved && h.isAvailable && !F,
                        et = (0, u.c)(async () => {
                            (W || h.isLiked || (K(!0), null == Y || Y()), await X(), null == E || E(h.isLiked));
                        }),
                        ei = (0, u.c)((e) => {
                            e.stopPropagation();
                        }),
                        er = (0, u.c)((e) => {
                            ...
                            (U.openTrackTrailer(h.id), J(d.DomainObjectType.Track, h.id));
                        }),
                        ea = (0, n.useMemo)(() => {
                            if (ee)
                                return (0, r.jsx)('div', {
                                    ...
                                    children: (0, r.jsx)(P._, {
                                        ...
                                        size: 'xs',
                                        utmLink: R,
                                        className: (0, a.$)(N().contextMenu, { [N().contextMenu_visible]: G }),
                                        handleRemove: D,
                                        withTrailer: M,
                    ...
                    return (0, r.jsxs)('div', {
                        ...
                        children: [
                            ...
                            Q && (0, r.jsx)('div', { className: (0, a.$)(N().item, N().downloadIcon), children: (0, r.jsx)(L, { track: h }) }),
                            D && !F && (0, r.jsx)(f, { size: 'xs', iconSize: 'xxs', className: (0, a.$)(N().item, N().removeButton), onClick: D, ariaLabel: z }),
                            ee &&
                                (0, r.jsx)(j.WithOffline, {
                                    fallback: (0, r.jsx)(A.c, {
                                        size: 'xs',
                                        iconSize: B,
                            ...
                            (0, r.jsxs)('div', {
                                ...
                                children: [
                                    'number' == typeof h.durationMs &&
                                        (0, r.jsx)(_.HL, {
                                            variant: 'span',
                                            className: (0, a.$)(N().duration, { [N().duration_hidden]: G && ee }),
                                            type: 'entity',
                                            size: 'm',
                                            weight: 'medium',
                                            'aria-label': Z,
        ...
        12989: (e, t, i) => {
            ...
            let x = () => {
                let e = (0, l.U)(),
                    ...
                    { tabId: y, tabPos: b, isTabSelectedByDefault: C } = (0, f.R)(),
                    { offsetBlockPosY: A } = (0, m.u)(),
                    { blockType: T, blockId: j, blockPosX: S, blockPosY: k, mainObjectId: P, mainObjectType: I, displayReasonId: N } = (0, u.N)(),
                    { filterKey: O, filterValue: E, filterPos: R } = (0, p.G)(),
                    { objectType: L, objectsCount: w, objectId: D, objectPosX: M, objectPosY: B } = (0, _.J)(),
                    { skeleton: z } = (0, h.b)(),
                    F = null != N ? N : g,
                    H = (0, o.L)(() => (void 0 !== A && void 0 !== k ? A + k : k));
                return (0, r.useCallback)(
                    (r, n) => {
                        ...
                        (void 0 !== O && ((l.filterKey = O), (l.filterValue = E), (l.filterPos = R)),
                            c.qG.includes(x) && ((l.tabId = y), (l.tabPos = b), (l.isTabSelectedByDefault = C)),
                            z && (l.skeletonId = z),
                    ...
                    [t, F, j, S, H, T, O, R, E, i, C, e, P, I, D, M, B, L, w, x, z, y, b],
                );
            };
        },
        13757: (e, t, i) => {
        ...
        13798: (e, t, i) => {
            ...
            let h = (0, s.PA)((e) => {
                let { className: t, getDescriptionTexts: i, trackId: s, containerClassName: _, variant: h, size: f = 'xxxs', ...x } = e,
                    ...
                    T = (0, n.useMemo)(() => g({ id: 'extra-explicit.explicit-mark' }), [g]);
                (0, n.useEffect)(() => {
                    i && i().then(C);
                }, [i, s]);
                let j = (null == b ? void 0 : b.join('\n')) || '',
                    S = !!(null == b ? void 0 : b.length) && !y,
                    k = j.length > 0 ? j : T;
                return (0, r.jsx)(p.k, {
                    description: j,
        ...
        19529: (e, t, i) => {
            ...
            let c = (e) => {
                ...
                return (0, r.jsx)(o.q, {
                    ...
                    className: (0, a.$)(d().root, d()['root_radius_'.concat(g)], { [d().root_withShadow]: !!t.entityType }, _),
                    radius: g,
                    onPlayButtonClick: c,
                    isPlaying: i,
                    isCurrent: l,
            ...
            let E = (0, s.PA)((e) => {
                ...
                let {
                    ...
                    } = e,
                    {
                        fullscreenPlayer: et,
                        sonataState: ei,
                        settings: { isMobile: er },
                    } = (0, y.g)(),
                    { formatMessage: ea } = (0, l.A)(),
                    es = (0, j.$)({ withCustomTooltip: G }),
                    en = (0, n.useSearchParams)(),
                    eo = R.getUrl($ ? Object.fromEntries(en) : void 0),
                    el = R.pubDate ? new Date(R.pubDate) : new Date(),
                    ed = (0, f.L)(el),
                    ec = !1,
                    eu = (0, g.Z)(null != (N = null == (t = R.mainAlbum) ? void 0 : t.url) ? N : ''),
                    em = (0, o.useMemo)(() => {
                        var e;
                        let t = ea({ id: 'entity-names.podcast-name' }, { podcastName: R.title });
                        return ''.concat(t, ' ').concat(null != (e = R.version) ? e : '');
                    }, [ea, R.title, R.version]),
                    ep = !!(B && Y && R.shouldRememberPosition && R.streamProgress && R.durationMs),
                    e_ =
                        R.id === (null == (i = ei.entityMeta) ? void 0 : i.id) &&
                        (null == (P = ei.entityMeta) || null == (s = P.streamProgress) ? void 0 : s.endPositionSec),
                    ev = (0, k.d)(ep, R.streamProgress, e_),
                    eh = R.mainAlbum && w && !ev,
                    ef = R.pubDate && D && !ev,
                    ex = (0, x.l)({ entity: null != (E = R.mainAlbum) ? E : null, entityType: C.n.PODCAST, callback: eu }),
                    eg = (0, m.c)((e) => {
                        (et.modal.isOpened && et.modal.close(), ex(e));
                    }),
                    ey = (0, S.O)({ track: R, withSavingQueryParams: $, entityType: C.n.PODCAST }),
                    eb = (0, o.useCallback)(() => {
                        switch (ed) {
                            case f.r.TODAY:
                            ...
                            case f.r.DATE_WITH_YEAR:
                                return (0, r.jsx)(c.XU, { value: R.pubDate, month: 'long', day: 'numeric', year: 'numeric' });
                            default:
                                return (0, r.jsx)(c.XU, { value: R.pubDate, month: 'long', day: 'numeric' });
                        }
                    }, [R.pubDate, ed]);
                R.pubDate && D && (ec = [f.r.TODAY, f.r.YESTERDAY].includes(ed));
                let eC = (0, o.useCallback)(
                    ...
                    eA = (0, o.useMemo)(
                        ...
                        [er, R.isRemoved, R.hasTrackLink, R.title, eC, es, ea, ey, eo, em],
                    ),
                    eT = (0, p.L)(() => {
                        var e;
                        if (!eh) return;
                        let t = (0, r.jsx)(_.m_, {
                            ...
                            hoverSettings: b.V,
                            children: (0, r.jsx)(v.HL, { variant: 'span', type: 'entity', size: z, className: I().albumTitle, children: R.mainAlbum.title }),
                        });
                        return ee
                            ? (0, r.jsx)(T.N, {
                ...
                return (0, r.jsx)('div', {
                    className: (0, a.$)(I().root, { [I().root_disabled]: !R.isAvailable, [I().root_disliked]: R.isDisliked && !K, [I().root_withSecondaryColor]: M }, L),
                    children: (0, r.jsxs)('div', {
                        className: (0, a.$)(I().metaContainer, O().podcastMetaContainer, J),
                        children: [
                            ep &&
                                Y &&
                                R.streamProgress &&
                                (0, r.jsx)(h.B, {
                                    className: (0, a.$)(O().progress, Q, {
                                        [O().progress_withPreviousInfo]: eh || ef,
                                        [O().progress_disabled]: !R.isAvailable || R.isDisliked,
                                    }),
                                    id: R.id,
                                    albumId: R.albumId,
                            ...
                            (0, r.jsxs)('div', {
                                className: (0, a.$)(I().titleContainer, U, O().podcastTitleContainer),
                                children: [
                                    (0, r.jsxs)(v.HL, {
                                        className: (0, a.$)(I().text, V),
                                        type: 'entity',
                                        size: z,
                                        variant: 'div',
                                        lineClamp: Z,
                            ...
                            (eh || ef) &&
                                (0, r.jsxs)(v.HL, {
                                    ...
                                    variant: 'div',
                                    lineClamp: 1,
                                    className: (0, a.$)(I().text, O().podcastName, V),
                                    children: [
                                        eT,
                                        ef &&
                                            (0, r.jsx)(v.HL, {
                                                ...
                                                className: (0, a.$)({
                                                    [O().dateWithName]: eh,
                                                    [O().soonDate]: ec,
                                                    [O().dateDisabled]: !R.isAvailable,
                                                    [O().dateDisliked]: R.isDisliked && !K,
                                                }),
                                                children: eb(),
                                            }),
                                    ],
        ...
        37445: (e, t, i) => {
            ...
            let S = (0, o.PA)((e) => {
                let { agent: t, isPlaying: i } = e,
                    ...
                    { state: C, toggleTrue: T, toggleFalse: S } = (0, _.e)(!1),
                    { theme: k } = (0, f.W)(),
                    P = (0, d.useRef)(null),
                        ...
                        if (o && O && k) {
                            ...
                            let {
                                    ...
                                    let { averageColor: t, theme: i, custom: r } = e,
                                        { h: a, s, l: n } = (0, x.hexToHsl)(t);
                                    if (r) {
                                        if (i === y.S.Dark) {
                                            let e = b(s + 5, 50, 100);
                                            return { color: g(a, e, b(n - 40, 12, 25)), glow1: g(a, e, b(n - 5, 45, 60)), glow2: g(a, e, b(n + 35, 80, 90)) };
                                        }
                                        let e = b(s - 2, 50, 100);
                                        return { color: g(a, e, b(n + 43, 80, 95)), glow1: g(a, e, b(n + 5, 45, 75)), glow2: g(a, e, b(n, 35, 55)) };
                                    }
                                    return { color: g(a, (s > 25 ? Math.min(s + 25, 60) : s) / 100, (n > 20 ? Math.min(n + 15, 60) : n) / 100) };
                            ...
                            (await (null == a ? void 0 : a.setThemeData(s)), T());
                        }
                    }),
                    L = (0, m.c)(() => {
                        (l(), R());
                ...
                return (0, r.jsxs)('div', {
                    ref: P,
                    className: (0, n.$)(A().root, { [A().root_loading]: w }),
                    style: D,
                    'data-test-id': w ? c.OA.vibe.VIBE_AGENT_LOADING_CARD : void 0,
                    children: [
                        (0, r.jsxs)('div', {
                            className: (0, n.$)(A().cover, { [A().cover_round]: I, [A().cover_square]: N, [A().cover_loading]: w }),
                            children: [
                                t.entityType &&
                                    E &&
                                    (0, r.jsx)(v._V, { src: E, size: 200, fit: 'cover', withAvatarReplace: !0, className: A().image, withLoadingIndicator: !1 }),
                                (0, r.jsx)(j, { src: t.animationUri, loop: !0, dotLottieRefCallback: s, className: A().animation }),
                            ],
                        }),
                        (0, r.jsx)(h.W, { className: (0, n.$)(A().shimmer, { [A().shimmer_loading]: w }), isActive: !0, radius: I ? 'round' : 'm' }),
                    ],
                });
            });
        },
        ...
        41566: (e, t, i) => {
            ...
            var r = i(32290),
                ...
                d = i(57594);
            let c = (0, a.PA)((e) => {
                let { isLiked: t, onClick: i, className: a, albumType: c, disabled: u } = e,
                    { user: m } = (0, d.g)(),
                    p = t ? 'liked' : 'like',
                    _ = (0, l.$)(t, c);
                return (0, r.jsx)(o.Dr, {
        ...
        41677: (e, t, i) => {
            ...
            let C = (0, s.PA)((e) => {
                    let {
                        ...
                        j = (0, x.Z)(t.url),
                        { sendNavigateSearchFeedback: S } = (0, g.z)(),
                        k = (0, f.N)(),
                        P = ((e) => {
                            ...
                            artist: t,
                            callback: (0, v.c)((e) => {
                                (T && A.isOpened && A.close(), j(e));
                            }),
                        }),
                        I = (0, v.c)((e) => {
                            (k({ to: p.AppScreen.ArtistScreen }), null == S || S(), P(e));
                        });
                    return i && !t.various
                        ? (0, r.jsx)(y.N, {
                              ...
                              children: (0, r.jsx)(o.m_, {
                                  ...
                                  text: d || t.name,
                                  hoverSettings: u,
                                  children: (0, r.jsx)(h.HL, { variant: 'span', type: 'entity', size: n, weight: 'medium', className: s, children: t.name }),
                              }),
                          })
                        : (0, r.jsx)(o.m_, {
                              enabled: !d && c,
            ...
            let R = (0, s.PA)((e) => {
                    ...
                    return (0, r.jsxs)(o.m_, {
                        ...
                        children: [
                            ...
                            (0, r.jsx)(o.ZI, { className: E().tooltipContent, children: i.map((e) => (0, r.jsx)(N.V, { artist: e, className: E().artistItem }, e.id)) }),
                        ],
                    });
                }),
                L = (0, n.forwardRef)((e, t) => (0, r.jsx)(R, { forwardRef: t, ...e }));
            var w = i(19740),
                D = i(52598),
                M = i.n(D);
            let B = (0, s.PA)((e) => {
                    ...
                    return (0, r.jsx)(w.W1, {
                        ...
                        children: i.map((e) => (0, r.jsx)(N.V, { artist: e }, e.id)),
                    });
                }),
                z = (0, s.PA)((e) => {
                    ...
                    if (
                        ...
                        return (s || d) && (!d || 1 !== t.length) ? (d ? (0, r.jsx)(B, { artists: t, label: i }) : (0, r.jsx)(L, { artists: t, label: i })) : i;
                }),
                F = (0, s.PA)((e) => {
                    let {
                            className: t,
                        ...
                        }, [i, m, P, y, O, E, j, v, h, p, T, f, N, C, s]),
                        w = (0, n.useMemo)(() => {
                            if (!P && m && m < i.length) {
                                let e = i.length - m;
                                return (0, n.isValidElement)(b) ? b : (0, r.jsx)(S, { spoilerClassName: _, spoilerArtistsCount: e, handleOnSpoilerClick: R });
                            }
                        }, [i.length, R, P, _, b, m]),
                        D = (0, n.useMemo)(() => {
                        ...
                        M = (0, r.jsx)(o.m_, {
                            ...
                            children: (0, r.jsxs)('div', {
                                style: D,
                                className: (0, a.$)(u().root, u()['root_variant_'.concat(x)], { [u().root_clamp]: c && c > 0 }, { [u().ellipsis]: !c }, t),
                                title: g && N && !C && !j ? N : void 0,
                                children: [L, w],
                            }),
                        });
                    return j ? (0, r.jsx)(z, { labelRef: k, artists: i, label: M }) : M;
                });
        },
        44989: (e, t, i) => {
            'use strict';
                ...
                ((0, n.useEffect)(() => {
                    ...
                    (0, n.useEffect)(() => {
                        ...
                        (H &&
                            ...
                            D - ((null == P ? void 0 : P.endPositionSec) || 0) < 1 &&
                    ...
                    }, [R, P, H, F, M, S, null == L ? void 0 : L.entityMeta]));
                let U = (H && (null == L || null == (b = L.entityMeta) || null == (y = b.streamProgress) ? void 0 : y.endPositionSec)) || P.endPositionSec,
                    V = (0, h.m)(null != U ? U : 0, D),
                    Y = (0, n.useMemo)(() => {
                        var e, t, i;
                        if (
                        ...
                        H,
                        F,
                        null == L || null == (A = L.entityMeta) || null == (C = A.streamProgress) ? void 0 : C.hasEverFinished,
                        null == w || null == (T = w.meta) ? void 0 : T.listeningFinished,
                        E,
                        U,
                        V,
                    ]);
                return (0, r.jsx)('div', { className: (0, a.$)(g().root, j), 'data-test-id': l.OA.track.LISTENING_PROGRESS, children: Y });
            });
        },
        60244: (e, t, i) => {
            'use strict';
                    ...
                    return (0, s.c)(async () => {
                        if (e)
                            return _({ pageAlbumId: g, albumId: e.id, isNonMusic: e.isNonMusic })
                                ...
                                : t.isAuthorized
                                  ? x({ album: e })
                                  : void h((0, r.jsx)(c.h, { error: v({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: o.u.ERROR });
                    });
                };
        },
        63397: (e, t, i) => {
        ...
        63545: (e, t, i) => {
            Promise.resolve().then(i.bind(i, 99800));
        },
        64910: (e, t, i) => {
            'use strict';
            (Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        66162: (e, t, i) => {
            ...
            var r = i(32290),
                ...
                _ = i(75265);
            let v = (e) => {
                let { item: t, index: i, pageId: v, sendSearchFeedback: h, blockPosition: f = 0, objectPosX: x, objectPosY: g, objectsCount: y } = e;
                switch (t.type) {
        ...
        68912: (e, t, i) => {
            ...
            let j = (0, s.PA)((e) => {
                let {
                    ...
                    { sendNavigateSearchFeedback: U } = (0, _.z)(),
                    {
                        settings: { isMobile: V },
                    } = (0, v.g)(),
                    Y = (0, b.$)({ withCustomTooltip: R }),
                    W = (0, n.useSearchParams)(),
                    K = s.getUrl(w ? Object.fromEntries(W) : void 0),
                    G = (0, o.useMemo)(() => {
                        var e;
                        let t = H({ id: 'entity-names.track-name' }, { trackName: s.title });
                        return ''.concat(t, ' ').concat(null != (e = s.version) ? e : '');
                    }, [H, s.title, s.version]),
                    $ = (0, C.O)({ track: s, onNavigate: U, withSavingQueryParams: w, entityType: f.n.TRACK }),
                    q = (0, o.useCallback)(
                        (e) => {
                        ...
                        [V, Y, k, s.isRemoved, s.title, s.version],
                    ),
                    X = (0, o.useMemo)(() => {
                        ...
                        return s.isRemoved
                            ? (0, r.jsx)(u.m_, {
                                  ...
                                  children: (0, r.jsx)(m.HL, {
                                      ...
                                      weight: 'medium',
                                      variant: 'span',
                                      title: Y ? void 0 : H({ id: 'track-title.error-not-found' }),
                    ...
                    }, [V, s.title, s.isRemoved, s.version, s.hasTrackLink, q, Y, H, k, G, $, K, B]),
                    Z = (0, y.s)(s.artists, A),
                    J = (0, o.useMemo)(() => +!!L, [L]);
                return (0, r.jsx)('div', {
                    className: (0, a.$)(T().root, { [T().root_disabled]: !s.isAvailable, [T().root_disliked]: s.isDisliked && !E, [T().root_withSecondaryColor]: S }, t),
                    children: (0, r.jsxs)('div', {
                        ...
                        children: [
                            ...
                            Z.length > 0 &&
                                (0, r.jsx)(p.i, {
                                    className: (0, a.$)(T().text, { [T().artists]: L }, O, N),
                                    withAllArtistsTitle: I,
        ...
        78176: (e, t, i) => {
            ...
            let g = (0, s.PA)((e) => {
                let { artist: t, className: i } = e,
                    ...
                    C = (0, d.c)((e) => {
                        (s.modal.isOpened && s.modal.close(), y({ to: o.AppScreen.ArtistScreen }), f(e));
                    });
                return (0, r.jsxs)(r.Fragment, {
                    children: [
                        (0, r.jsxs)(u.Dr, {
        ...
        89957: (e, t, i) => {
            ...
            let r = (0, i(1987).createAsyncLocalStorage)();
        },
        90006: (e) => {
        ...
        99800: (e, t, i) => {
            ...
            let A = (0, s.PA)(() => {
                ...
                (t.isAuthorized && (0, n.notFound)(),
                    (0, o.useEffect)(() => {
                        j.current && A.canBack && j.current.focus();
                    }, [A.canBack]),
                    (0, o.useEffect)(
                        () => () => {
                            (null == T ? void 0 : T.current) ? (e.resetHistoryItems(), (T.current = !1)) : e.resetHistoryStateRequest();
                        },
                        [e],
                    ));
                let P = (0, o.useMemo)(
    ...
    (e) => {
        (e.O(
            0,
            [
                7412, 1010, 2147, 4517, 8461, 7231, 9763, 443, 6706, 5201, 5472, 8378, 900, 2536, 2146, 3353, 2474, 8035, 347, 1410, 229, 8506, 6050, 5806, 6241, 7702,
                6874, 9155, 861, 9740, 4499, 8915, 6341, 8160, 4220, 9562, 7358,
            ],
            () => e((e.s = 63545)),
        ),
            (_N_E = e.O()));
