(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
        ...
        5537: (e, t, s) => {
            ...
            let r = () => {
                ...
                return (
                    ...
                    s.isAuthorized &&
                    !s.hasPlus &&
                    (null == (t = l.getExperiment(a.z.WebNextDesktopWebFreemium)) || null == (e = t.value) ? void 0 : e.closeListening) === 'on'
                );
            };
        },
        7462: (e, t, s) => {
        ...
        12989: (e, t, s) => {
            ...
            let x = () => {
                let e = (0, o.U)(),
                    ...
                    { tabId: b, tabPos: g, isTabSelectedByDefault: C } = (0, v.R)(),
                    { offsetBlockPosY: S } = (0, m.u)(),
                    { blockType: k, blockId: T, blockPosX: j, blockPosY: N, mainObjectId: E, mainObjectType: I, displayReasonId: y } = (0, u.N)(),
                    { filterKey: L, filterValue: O, filterPos: P } = (0, p.G)(),
                    { objectType: R, objectsCount: w, objectId: D, objectPosX: M, objectPosY: H } = (0, h.J)(),
                    { skeleton: U } = (0, f.b)(),
                    z = null != y ? y : A,
                    W = (0, n.L)(() => (void 0 !== S && void 0 !== N ? S + N : N));
                return (0, i.useCallback)(
                    (i, l) => {
                        ...
                        (void 0 !== L && ((o.filterKey = L), (o.filterValue = O), (o.filterPos = P)),
                            d.qG.includes(x) && ((o.tabId = b), (o.tabPos = g), (o.isTabSelectedByDefault = C)),
                            U && (o.skeletonId = U),
                            'string' == typeof E && 'string' == typeof I && ((o.mainObjectType = I), (o.mainObjectId = E)),
                    ...
                    [t, z, T, j, W, k, L, P, O, s, C, e, E, I, D, M, H, R, w, x, U, b, g],
                );
            };
        },
        13798: (e, t, s) => {
            ...
            var i = s(32290),
                ...
                _ = s.n(h);
            let f = (0, r.PA)((e) => {
                let { className: t, getDescriptionTexts: s, trackId: r, containerClassName: h, variant: f, size: v = 'xxxs', ...x } = e,
                    ...
                    k = (0, l.useMemo)(() => A({ id: 'extra-explicit.explicit-mark' }), [A]);
                (0, l.useEffect)(() => {
                    s && s().then(C);
                }, [s, r]);
                let T = (null == g ? void 0 : g.join('\n')) || '',
            ...
            let C = (0, r.PA)((e) => {
                    let {
                        ...
                        E = ((e) => {
                            ...
                            artist: t,
                            callback: (0, _.c)((e) => {
                                (k && S.isOpened && S.close(), T(e));
                            }),
                        }),
                        I = (0, _.c)((e) => {
                            (N({ to: p.AppScreen.ArtistScreen }), null == j || j(), E(e));
                        });
                    return s && !t.various
                        ? (0, i.jsx)(b.N, {
                    ...
                    let {
                        ...
                        M = (0, i.jsx)(n.m_, {
                            ...
                            children: (0, i.jsxs)('div', {
                                style: D,
                                className: (0, a.$)(u().root, u()['root_variant_'.concat(x)], { [u().root_clamp]: d && d > 0 }, { [u().ellipsis]: !d }, t),
                                title: A && y && !C && !T ? y : void 0,
                                children: [R, w],
                            }),
                        });
                    return T ? (0, i.jsx)(U, { labelRef: N, artists: s, label: M }) : M;
                });
        },
        48736: (e) => {
            ...
            let O = (0, a.PA)((e) => {
                ...
                return (c.isNeededToLoad && (0, r.use)(c.getData()), !c.isLoading && (null == (t = c.entities) ? void 0 : t.length))
                    ? (0, i.jsx)(j.$, {
                          ...
                          shimmer: (0, i.jsx)(N.D, { variant: T.X.PLAYLIST, isActive: !0 }),
                              ...
                              (0, i.jsx)(c.N, {
                                  ...
                                  children: (0, i.jsxs)('div', {
                                      ...
                                      children: [
                                          ...
                                          (0, i.jsx)(x.A, { children: (0, i.jsx)(v.w, { className: R().footer }) }),
                                      ],
                                  }),
                              }),
                          ],
                        ...
                        x = (() => {
                            ...
                            return (0, r.c)(async (a) => {
                                ...
                                (s(!1),
                                    c &&
                                        (h === p.f.OK
                                            ? e((0, i.jsx)(v, { withLink: o, album: m }), { containerId: n.u.INFO })
        ...
        78176: (e, t, s) => {
            ...
            let A = (0, r.PA)((e) => {
                let { artist: t, className: s } = e,
                    ...
                    C = (0, c.c)((e) => {
                        (r.modal.isOpened && r.modal.close(), b({ to: n.AppScreen.ArtistScreen }), v(e));
                    });
                return (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsxs)(u.Dr, {
                            className: (0, a.$)(x().root, s),
                            onClick: C,
                            ...
                            children: [
                                (0, i.jsx)(m.t, {
                                    radius: 'round',
                                    className: x().cover,
                                    children: (0, i.jsx)(d._V, { withAvatarReplace: !0, src: t.coverUri, size: 100, fit: 'contain', className: x().image }),
                                }),
    ...
    (e) => {
        (e.O(
            0,
            [
                7412, 1010, 1256, 2147, 4517, 8461, 7231, 9763, 3608, 5974, 6054, 6706, 5472, 8378, 900, 2536, 2146, 3353, 2474, 8035, 347, 2732, 1410, 229, 8506, 6050,
                5806, 6241, 7702, 6874, 9155, 861, 4668, 9740, 1175, 4499, 8915, 6341, 6226, 606, 4220, 9562, 7358,
            ],
            () => e((e.s = 54545)),
        ),
            (_N_E = e.O()));
