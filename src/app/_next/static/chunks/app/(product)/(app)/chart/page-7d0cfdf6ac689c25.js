(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3737],
    {
                ...
                L = (0, r.PA)((e) => {
                    ...
                    let {
                        ...
                        es = (0, m.c)((e) => {
                            ...
                            ($.openTrackTrailer(x.id), Z(c.DomainObjectType.Track, x.id));
                        }),
                        ea = (0, n.useMemo)(() => {
                            if (ee)
                                return (0, s.jsx)('div', {
                                    ...
                                    children: (0, s.jsx)(I._, {
                                        ...
                                        size: 'xs',
                                        utmLink: P,
                                        className: (0, a.$)(y().contextMenu, { [y().contextMenu_visible]: V }),
                                        handleRemove: M,
                                        withTrailer: D,
                    ...
                    return (0, s.jsxs)('div', {
                        className: (0, a.$)(y().root, y().controls, r, {
                            [y().controls_dislikedControls]: x.isDisliked,
                            [y().controls_dislikedColors]: x.isDisliked && !R,
                            [y().controls_disabled]: !x.isAvailable,
                            [y().root_withSecondaryColor]: L,
                        }),
                        children: [
                            S &&
                                (0, s.jsx)(u.I, {
                            ...
                            J && (0, s.jsx)('div', { className: (0, a.$)(y().item, y().downloadIcon), children: (0, s.jsx)(E, { track: x }) }),
                            M && !W && (0, s.jsx)(v, { size: 'xs', iconSize: 'xxs', className: (0, a.$)(y().item, y().removeButton), onClick: M, ariaLabel: z }),
                            ee &&
                            ...
                            (0, s.jsxs)('div', {
                                className: (0, a.$)(y().item, y().contextMenuWrapper),
                                children: [
                                    'number' == typeof x.durationMs &&
                                        (0, s.jsx)(p.HL, {
                                            variant: 'span',
                                            className: (0, a.$)(y().duration, { [y().duration_hidden]: V && ee }),
                                            type: 'entity',
                                            size: 'm',
                                            weight: 'medium',
                                            'aria-label': Q,
        ...
        12989: (e, t, i) => {
            ...
            let C = () => {
                let e = (0, l.U)(),
                    ...
                    { tabId: g, tabPos: A, isTabSelectedByDefault: b } = (0, v.R)(),
                    { offsetBlockPosY: f } = (0, u.u)(),
                    { blockType: T, blockId: N, blockPosX: j, blockPosY: w, mainObjectId: I, mainObjectType: S, displayReasonId: y } = (0, m.N)(),
                    { filterKey: R, filterValue: O, filterPos: P } = (0, _.G)(),
                    { objectType: E, objectsCount: L, objectId: M, objectPosX: D, objectPosY: B } = (0, p.J)(),
                    { skeleton: z } = (0, x.b)(),
                    W = null != y ? y : k,
                    U = (0, o.L)(() => (void 0 !== f && void 0 !== w ? f + w : w));
                return (0, s.useCallback)(
                    (s, n) => {
                        ...
                        (void 0 !== R && ((l.filterKey = R), (l.filterValue = O), (l.filterPos = P)),
                            d.qG.includes(C) && ((l.tabId = g), (l.tabPos = A), (l.isTabSelectedByDefault = b)),
                            z && (l.skeletonId = z),
                            'string' == typeof I && 'string' == typeof S && ((l.mainObjectType = S), (l.mainObjectId = I)),
                            W && (l.displayReasonId = W));
                        let m = (0, a.F)({ params: l, logger: e, context: 'useSendEventOnBlockShowedOrHidden' });
                        m && (s ? (0, r.Pf)(t.evgenInstance, m) : (0, r.nv)(t.evgenInstance, m));
                    },
                    [t, W, N, j, U, T, R, P, O, i, b, e, I, S, M, D, B, E, L, C, z, g, A],
                );
            };
        },
        13365: (e, t, i) => {
        ...
        25023: (e, t, i) => {
            'use strict';
            i.d(t, { ChartTracksPageSuspenseLoader: () => g });
            var s = i(32290),
                a = i(63618),
                r = i(55178),
                n = i(60900),
            ...
            let g = () => {
                let { formatMessage: e } = (0, n.A)(),
                    ...
                    i = (0, c.W)(),
                    { contentScrollRef: C, setContentScrollRef: g } = (0, d.g)(),
                    A = (0, r.useCallback)(() => (0, s.jsx)(v.r, { isActive: !0, className: k().shimmerItem }), []),
        ...
        29268: (e, t, i) => {
            ...
            let d = (e) => {
                    let {
                        ...
                        g = k({ id: 'trailer.button-aria-label' });
                    return (0, s.jsx)(o.$, {
                        className: h,
                        color: 'secondary',
                        radius: d,
        ...
        41677: (e, t, i) => {
            ...
            let b = (0, r.PA)((e) => {
                    let {
                        ...
                        S = (0, h.c)((e) => {
                            (w({ to: _.AppScreen.ArtistScreen }), null == j || j(), I(e));
                        });
                    return i && !t.various
                        ? (0, s.jsx)(g.N, {
            ...
            let P = (0, r.PA)((e) => {
                    ...
                    return (0, s.jsxs)(o.m_, {
                        ...
                        children: [
                            ...
                            (0, s.jsx)(o.ZI, { className: O().tooltipContent, children: i.map((e) => (0, s.jsx)(y.V, { artist: e, className: O().artistItem }, e.id)) }),
                        ],
                    });
                }),
                E = (0, n.forwardRef)((e, t) => (0, s.jsx)(P, { forwardRef: t, ...e }));
            var L = i(19740),
                M = i(52598),
                D = i.n(M);
            let B = (0, r.PA)((e) => {
                    ...
                    return (0, s.jsx)(L.W1, {
                        ...
                        children: i.map((e) => (0, s.jsx)(y.V, { artist: e }, e.id)),
                    });
                }),
                z = (0, r.PA)((e) => {
                    ...
                    if (
                        ...
                        return (r || c) && (!c || 1 !== t.length) ? (c ? (0, s.jsx)(B, { artists: t, label: i }) : (0, s.jsx)(E, { artists: t, label: i })) : i;
                }),
                W = (0, r.PA)((e) => {
                    let {
                            className: t,
                        ...
                        }, [i, u, I, g, R, O, N, h, x, _, T, v, y, b, r]),
                        L = (0, n.useMemo)(() => {
                            if (!I && u && u < i.length) {
                                let e = i.length - u;
                                return (0, n.isValidElement)(A) ? A : (0, s.jsx)(j, { spoilerClassName: p, spoilerArtistsCount: e, handleOnSpoilerClick: P });
                            }
                        }, [i.length, P, I, p, A, u]),
                        M = (0, n.useMemo)(() => {
        ...
        55646: (e, t, i) => {
            ...
            let P = (0, r.PA)(() => {
                let { formatMessage: e } = (0, o.A)(),
                    ...
                    E = (0, A.w)(),
                    { from: L } = (0, v.f)({ pageId: h._Q.CHART });
                (0, g.J)(t.isResolved);
                let M = t.isLoading || !t.playlistMeta,
                    D = M ? S.H : t.items.length,
                    B = (0, n.useCallback)(
                        (e) => {
                            let i = t.items[e],
                                a = t.playlistMeta;
                            return i && a && !M
                                ? (0, s.jsx)(p.Q, {
                                      ...
                                      playContextParams: E(e, {
                                          contextData: { type: c.K.Playlist, meta: { id: ''.concat(a.uid, ':').concat(a.kind) }, from: L },
                                          queueParams: { index: e, entityId: i.id },
                                          loadContextMeta: !0,
                                      }),
                                  })
                                : (0, s.jsx)(y.r, { isActive: !0, className: O().shimmerItem });
                        },
        ...
        68912: (e, t, i) => {
            ...
            let N = (0, r.PA)((e) => {
                let {
                    ...
                    F = r.getUrl(L ? Object.fromEntries(Y) : void 0),
                    V = (0, o.useMemo)(() => {
                        var e;
                        let t = U({ id: 'entity-names.track-name' }, { trackName: r.title });
                        return ''.concat(t, ' ').concat(null != (e = r.version) ? e : '');
                    }, [U, r.title, r.version]),
                    G = (0, b.O)({ track: r, onNavigate: $, withSavingQueryParams: L, entityType: v.n.TRACK }),
                    q = (0, o.useCallback)(
                        (e) => {
                ...
                return (0, s.jsx)('div', {
                    ...
                    children: (0, s.jsxs)('div', {
                        ...
                        children: [
                            ...
                            Q.length > 0 &&
                                (0, s.jsx)(_.i, {
                                    className: (0, a.$)(T().text, { [T().artists]: E }, R, y),
                                    withAllArtistsTitle: S,
        ...
        78176: (e, t, i) => {
            ...
            let k = (0, r.PA)((e) => {
                let { artist: t, className: i } = e,
                    ...
                    b = (0, c.c)((e) => {
                        (r.modal.isOpened && r.modal.close(), g({ to: o.AppScreen.ArtistScreen }), v(e));
                    });
                return (0, s.jsxs)(s.Fragment, {
                    children: [
                        (0, s.jsxs)(m.Dr, {
        ...
        92102: (e, t, i) => {
            ...
            let b = (0, r.PA)((e) => {
                ...
                let {
                    ...
                    J = (0, o.c)(() => {
                        M.open({ trackId: r.id, albumId: r.albumId });
                    }),
                    ...
                    ea = (0, o.c)(() => {
                        if (!Y()) {
                            ...
                            (ei || j || (es(!0), null == et || et()), Z(), K(!j), null == y || y(!j));
                        }
                    }),
                    er = (0, o.c)(() => {
                        if (j) return void S();
                    ...
                    en = (0, o.c)((e) => {
                        if (!r.isAvailable && !r.hasModalAccess) {
                            (E && r.isAvailableOnlyForPlus && L(), X && r.isAvailableOnlyForPlus && U.open());
                            return;
                        }
                        if (q) return void L();
                ...
                return (0, s.jsxs)(v.C, {
                    ...
                    onClick: en,
                    className: (0, a.$)(A().root, { [A().root_disabled]: !r.isAvailable, [A().root_current]: w && B }, i),
                    ...P,
                    children: [b, eo, g, f],
                });
            });
    ...
    (e) => {
        (e.O(
            0,
            [
                1010, 7412, 8461, 7231, 2147, 9763, 4517, 1256, 3608, 6087, 6706, 1311, 5472, 8378, 900, 2536, 2146, 3353, 2474, 8035, 347, 2732, 1410, 1417, 8506, 6050,
                5806, 7702, 6874, 9155, 861, 4668, 9740, 1175, 4499, 8915, 6341, 5814, 4220, 9562, 7358,
            ],
            () => e((e.s = 73952)),
        ),
            (_N_E = e.O()));
