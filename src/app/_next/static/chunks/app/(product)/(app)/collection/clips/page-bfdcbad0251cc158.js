(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9923],
    {
            ...
            let x = [
                ...
                h = () => {
                    let e = (0, n.st)(),
                        ...
                        { blockId: E, blockType: A, blockPosX: I, blockPosY: T, mainObjectId: O, mainObjectType: b } = (0, u.N)(),
                        { objectId: R, objectPosX: L, objectPosY: N, objectType: j, objectsCount: P } = (0, p.J)(),
                        { skeleton: k } = (0, f.b)(),
                        w = (0, a.L)(() => (void 0 !== S && void 0 !== T ? S + T : T));
                    return (0, i.useCallback)(
                        (i, n) => {
                            if (!e || !h || !d.xK.includes(h) || !i || !x.includes(h)) return;
                            let a = c.F[h];
                            if (!a) return;
                            let s = {
                                hash: r,
                            ...
                            (d.qG.includes(h) && ((s.tabId = C), (s.tabPos = g), (s.isTabSelectedByDefault = y)),
                                k && (s.skeletonId = k),
                                O && b && ((s.mainObjectType = b), (s.mainObjectId = O)));
                            let u = (0, o.F)({ params: s, logger: t, context: 'useSendEventOnBlockStarted' });
                            u && (0, l.er)(e.evgenInstance, u);
                        },
                        [e, h, r, A, E, I, w, R, j, L, N, P, k, O, b, t, C, g, y],
                    );
                };
        },
        3377: (e, t, r) => {
        ...
        12113: (e, t, r) => {
            ...
            let U = (0, n.PA)((e) => {
                ...
                let {
                    ...
                    er = (0, a.useMemo)(() => Y.ids.indexOf(D.clipId), [Y, D.clipId]),
                    { isPlaying: ei, togglePlay: eo } = (0, L.D)({
                        playContextParams: {
                            contextData: { type: u.K.Various, meta: { id: b.H.VARIOUS_CLIP_CONTEXT }, from: K },
                    ...
                    el = W ? D.url : (0, g.J)(Y.ids, er),
                    en = (0, _.c)(() => {
                        W ? (z([D.clipId]), X()) : ei || eo();
                    }),
                    ea = (0, w.X)({ clip: D, callback: en }),
                    es = F({ id: 'entity-names.clip-name' }, { clipName: D.title }),
                    ec = (0, a.useMemo)(
                        () =>
                            D.isAvailable
                                ? (0, i.jsxs)(f.t, {
                                      radius: 'm',
                                      className: (0, o.$)(M().view, M().cover),
                                      onMouseEnter: ee,
                                      onMouseLeave: et,
                                      onClick: ea,
                                      children: [
                                          $ &&
                                              (0, i.jsx)('video', {
                                                  className: M().media,
                                                  ref: J,
                                                  poster: D.thumbnail && (0, c.createAvatarVideoUrl)(D.thumbnail, 1280),
                                                  playsInline: !0,
                                                  muted: !0,
                                                  loop: !0,
                                                  'aria-hidden': !0,
                                          ...
                                          (0, i.jsx)(k.D, { variant: 'filled', className: M().playButton, onClick: ea, iconSize: 'xl' }),
                                      ],
                                  })
                                : (0, i.jsx)(f.t, {
                                      radius: 'm',
                        ...
                        [V, D.isAvailable, D.thumbnail, D.previewUrl, D.duration, ee, et, ea, $],
                    ),
                    ed = (0, a.useMemo)(
                        () =>
                            D.hasArtists
                                ? (0, i.jsx)(
                                      x.i,
                                      { linkClassName: (0, o.$)(M().artistLink, n), artists: D.artists, lineClamp: 1, withAllArtistsTitle: !0, artistIdWithoutLink: B },
                ...
                return (0, i.jsx)(p.MN, {
                    ...
                    'aria-label': es,
                    srTitle: (0, i.jsx)(P.N, { href: el, onClick: ea, children: es }),
                    title: (0, i.jsxs)(
                        v.HL,
                        {
                            className: (0, o.$)(M().title, r),
                            variant: 'div',
                            type: 'entity',
                            size: 'm',
                            weight: 'medium',
            ...
            let h = () => {
                ...
                return (0, i.useCallback)(
                    (i, n) => {
                        ...
                        (void 0 !== N && ((s.filterKey = N), (s.filterValue = j), (s.filterPos = P)),
                            d.qG.includes(h) && ((s.tabId = g), (s.tabPos = y), (s.isTabSelectedByDefault = S)),
                            B && (s.skeletonId = B),
                            'string' == typeof b && 'string' == typeof R && ((s.mainObjectType = R), (s.mainObjectId = b)),
                            H && (s.displayReasonId = H));
                        let u = (0, o.F)({ params: s, logger: e, context: 'useSendEventOnBlockShowedOrHidden' });
                        u && (i ? (0, l.Pf)(t.evgenInstance, u) : (0, l.nv)(t.evgenInstance, u));
                    },
                    [t, H, I, T, W, A, N, P, j, r, S, e, b, R, D, M, U, k, w, h, B, g, y],
                );
            };
        },
        13798: (e, t, r) => {
        ...
        15559: (e, t, r) => {
            ...
            var i = r(79406);
            let o = (e) => {
                let { checkExperiment: t, getDisclaimerContent: r, getExplicitContent: o, userRegion: l } = e;
                return 'ru' === l && t(i.z.WebNextFooterDisclaimer, 'on') ? r() : o();
            };
        },
        16510: (e) => {
        ...
        19383: (e, t, r) => {
            ...
            let u = (e) => {
                ...
                return (
                    (0, i.useEffect)(() => {
                        h.isUnsafeDisclaimerConfirmed && h.id === g.current && !y.current && (T(), (y.current = !0));
                            ...
                            try {
                                if ((null == m || m(e), t)) {
                                    ...
                                    if (t.isUnsafeLegal) {
                                        ...
                                        if (null == t ? void 0 : t.includes(a)) return void T(e);
                                    }
                                    if (s) {
        ...
        19620: (e, t, r) => {
            ...
            let h = (e) => {
                    ...
                    let $ = (0, l.useMemo)(
                                ...
                                C && y && R
                                    ...
                                    : (0, i.jsxs)('div', {
                                          ...
                                          children: [
                                              (0, i.jsx)(_.DZ, {
                                                  id: v,
                                                  className: (0, o.$)(x().heading, T, { [x().heading_notAvailable]: !R }),
                                                  variant: w,
                                                  size: E,
                                                  weight: 'bold',
                                                  lineClamp: O,
                            ...
                            [R, J, P, w, v, C, T, O, E, y, N],
                        ),
                        q = (0, l.useMemo)(() => (H && M ? (0, i.jsx)(u.W, { isActive: U, className: x().shimmerDescription }) : g), [H, M, g, U]),
                        ee = (0, l.useMemo)(
                            () =>
                                B && M
                    ...
                    return (0, i.jsxs)('div', {
                        ...
                        children: [
                            (0, i.jsxs)('div', {
                                className: x().start,
                                children: [
                                    Q && (0, i.jsx)(d.t, { radius: I, className: (0, o.$)(x().coverContainer, k), children: ee }),
                                    (0, i.jsxs)('div', {
                                        ...
                                        children: [
                                            ...
                                            X &&
                                                (0, i.jsx)(_.HL, {
                                                    ...
                                                    className: (0, o.$)(x().description, { [x().description_widthLimit]: D }),
        ...
        26089: (e, t, r) => {
            ...
            let m = (e) => {
                let t = (0, l.st)(),
                    ...
                    { blockType: h, blockId: C, blockPosX: g, blockPosY: y, mainObjectType: S, mainObjectId: E } = (0, s.N)(),
                    { objectsCount: A, objectType: I, objectId: T, objectPosX: O, objectPosY: b } = (0, c.J)(),
                    R = (0, p.U)(),
                    { skeleton: L } = (0, u.b)();
                return (0, n.c)((l) => {
                    ...
                    (a.qG.includes(m) && ((n.tabId = f), (n.tabPos = v), (n.isTabSelectedByDefault = x)),
                        L && (n.skeletonId = L),
                        S && (n.mainObjectType = S),
                        E && (n.mainObjectId = E));
                    let s = (0, i.F)({ params: n, logger: R, context: 'useSendEventOnClipShowedOrHidden' });
                    if (s) {
                        if (l) return void (0, o.Pf)(t.evgenInstance, s);
                        (0, o.nv)(t.evgenInstance, s);
                    }
                });
            };
        },
                            ...
                            return null == g
                                ...
                                : g.map((e, t) =>
                                      (0, i.jsx)(
                                          d.B,
                                          {
                                              objectType: s.DomainObjectType.Video,
                                              objectPosX: t + 1,
                                              objectPosY: 1,
                ...
                return (
                    ...
                    (0, i.jsx)(U.F, {
                        ...
                        children: (0, i.jsx)(D.K, {
                            className: (0, b.$)(H().root, r),
                            containerClassName: H().carouselBlock,
                            carouselItemClassName: (0, b.$)(H().carouselItem, H().important),
                            headerClassName: (0, b.$)(H().carouselBlockHeader, H().carouselBlock),
                        ...
                        'div',
                        {
                            ...
                            children: [
                                (0, i.jsx)('div', {
                                    ...
                                    className: (0, b.$)(Q().virtualItemRow, {
                    ...
                    o.isEmpty)
                        ...
                        : o.isRejected
                          ...
                          : (0, i.jsx)('div', {
                                ...
                                children: h.map((e) => (0, i.jsx)(X, { virtualItem: e, resizeObserver: f, columns: a }, e.index)),
                            });
                }),
                Z = (0, o.PA)(() => {
                    let {
                        ...
                        r = (0, h.W)(),
                        o = (0, m.d)(),
                        { contentScrollRef: T, setContentScrollRef: b } = (0, C.g)();
                                  ...
                                  children: (0, i.jsxs)(p.h, {
                                      ...
                                      children: [
                                          ...
                                          (0, i.jsxs)(d.C, {
                                              ...
                                              scrollContentClassName: O().scrollContent,
                                              'data-test-id': c.Xk.collection.COLLECTION_CLIPS_PAGE,
                                              children: [
                                                  (0, i.jsx)(G, { contentScrollRef: T }),
                                                  (0, i.jsx)(A.A, { children: (0, i.jsx)(E.w, { className: O().footer }) }),
                                              ],
                                          }),
                                      ],
                                  }),
        ...
        41677: (e, t, r) => {
            ...
            let S = (0, l.PA)((e) => {
                    let {
                        ...
                        I = (0, h.Z)(t.url),
                        { sendNavigateSearchFeedback: T } = (0, C.z)(),
                        O = (0, x.N)(),
                        b = ((e) => {
                            ...
                            artist: t,
                            callback: (0, f.c)((e) => {
                                (A && E.isOpened && E.close(), I(e));
                            }),
                        }),
                        R = (0, f.c)((e) => {
                            (O({ to: p.AppScreen.ArtistScreen }), null == T || T(), b(e));
                        });
                    return r && !t.various
                        ? (0, i.jsx)(g.N, {
            ...
            let P = (0, l.PA)((e) => {
                    ...
                    return (0, i.jsxs)(a.m_, {
                        ...
                        children: [
                            ...
                            (0, i.jsx)(a.ZI, { className: j().tooltipContent, children: r.map((e) => (0, i.jsx)(L.V, { artist: e, className: j().artistItem }, e.id)) }),
                        ],
                    });
                }),
                k = (0, n.forwardRef)((e, t) => (0, i.jsx)(P, { forwardRef: t, ...e }));
            var w = r(19740),
                D = r(52598),
                M = r.n(D);
            let U = (0, l.PA)((e) => {
                    ...
                    return (0, i.jsx)(w.W1, {
                        isMobile: !0,
                        className: (0, o.$)(M().root, M().important),
                        label: t,
                        ariaLabel: l({ id: 'interface-actions.context-menu-artists' }),
                        children: r.map((e) => (0, i.jsx)(L.V, { artist: e }, e.id)),
                    });
                }),
                B = (0, l.PA)((e) => {
                    ...
                    if (
                        ...
                        return (l || c) && (!c || 1 !== t.length) ? (c ? (0, i.jsx)(U, { artists: t, label: r }) : (0, i.jsx)(k, { artists: t, label: r })) : r;
                }),
                H = (0, l.PA)((e) => {
                    let {
                            className: t,
                        ...
                        }, [r, _, b, g, N, j, I, f, v, p, A, x, L, S, l]),
                        w = (0, n.useMemo)(() => {
                            if (!b && _ && _ < r.length) {
                                let e = r.length - _;
                                return (0, n.isValidElement)(y) ? y : (0, i.jsx)(T, { spoilerClassName: m, spoilerArtistsCount: e, handleOnSpoilerClick: P });
                            }
                        }, [r.length, P, b, m, y, _]),
                        D = (0, n.useMemo)(() => {
                        ...
                        M = (0, i.jsx)(a.m_, {
                            ...
                            children: (0, i.jsxs)('div', {
                                ...
                                title: C && L && !S && !I ? L : void 0,
                                children: [k, w],
                            }),
                        });
                    return I ? (0, i.jsx)(B, { labelRef: O, artists: r, label: M }) : M;
                });
        },
        41878: (e, t, r) => {
        ...
        56797: (e, t, r) => {
            ...
            let v = (e) => {
                let t = (0, n.st)(),
                    { hash: r } = (0, n.gf)(),
                    { pageId: v } = (0, _.$)(),
                    { tabId: x, tabPos: h, isTabSelectedByDefault: C } = (0, m.R)(),
                    { skeleton: g } = (0, p.b)(),
                    { blockType: y, blockId: S, blockPosX: E, blockPosY: A, mainObjectType: I, mainObjectId: T } = (0, d.N)(),
                    { objectsCount: O, objectType: b, objectId: R, objectPosX: L, objectPosY: N } = (0, u.J)(),
                    j = (0, f.U)();
                return (0, a.c)(() => {
                    ...
                    (c.qG.includes(v) && ((n.tabId = x), (n.tabPos = h), (n.isTabSelectedByDefault = C)),
                        g && (n.skeletonId = g),
                        I && (n.mainObjectType = I),
                        T && (n.mainObjectId = T));
                    let a = (0, i.F)({ params: n, logger: j, context: 'useSendEventOnClipNavigated' });
                    a && e && (0, l.QS)(t.evgenInstance, a);
                });
            };
        },
        57594: (e, t, r) => {
        ...
        64170: (e, t, r) => {
            ...
            let E = (0, l.PA)((e) => {
                let { className: t, withBackwardControl: r = !0 } = e,
                    ...
                    y = l({ id: 'error-messages.something-went-wrong' });
                !(function (e) {
                    let t = (0, f.st)(),
                        { hash: r } = (0, f.gf)(),
                        { pageId: i } = (0, x.$)(),
                ...
                let { sendRefreshEvent: E } = (function () {
                        ...
                        return {
                            sendRefreshEvent: (0, n.useCallback)(() => {
                                ...
                                o && (0, m.bv)(e.evgenInstance, o);
                            }, [e, t, r, i]),
                        };
                    })(),
                    A = (0, n.useCallback)(() => {
                        (E(), (window.location.href = C.Z.main.href));
                    }, [E]),
                    { contentRef: I } = (0, h.g)();
                return (0, i.jsxs)('div', {
                    className: (0, o.$)(S().root, t),
                    children: [
                        r &&
                            (0, i.jsx)(g.L, { withBackwardFallback: '/', className: (0, o.$)(S().navigation, { [S().navigation_desktop]: !I }), withForwardControl: !1 }),
                        (0, i.jsxs)('div', {
                            className: (0, o.$)(S().content, { [S().content_shrink]: !r }),
                            children: [
                                (0, i.jsx)(d.I, { className: S().icon, variant: 'attention', size: 'xxl' }),
                                (0, i.jsx)(u.DZ, { className: (0, o.$)(S().title, S().important), variant: 'h3', size: 'xs', children: y }),
                                (0, i.jsxs)(u.HL, {
                                    className: (0, o.$)(S().text, S().important),
                                    variant: 'span',
                                    type: 'text',
                                    size: 'l',
                                    weight: 'normal',
                    ...
                    1229: (e, t, r) => {
                        ...
                        t.useTooltip = function (e) {
                            let {
                                ...
                                E = S.context,
                                A = (0, l.useHover)(E, { move: !1, enabled: c && f, ...m }),
                                I = (0, l.useFocus)(E, { enabled: d && f }),
                                T = (0, l.useDismiss)(E),
                                O = (0, l.useRole)(E, { role: 'tooltip' }),
                                b = (0, l.useInteractions)([A, I, T, O]),
                                R = (0, o.useMemo)(() => {
                                    if (v) return (0, i.jsx)(l.FloatingArrow, { ref: C, context: S.context, ...v });
                                }, [v, S.context]);
                            return (0, o.useMemo)(() => {
                                var e;
                                return { open: g, setOpen: y, arrow: R, referenceHidden: null == (e = S.middlewareData.hide) ? void 0 : e.referenceHidden, ...b, ...S };
                            }, [g, y, R, b, S]);
                        };
                    },
                    3412: function (e, t, r) {
                ...
                _ = (e) => {
                    let t = ((e) => {
                            let t = null == e ? void 0 : e.pageId,
                                ...
                                { pageId: a, pageEntityId: s } = (0, l.$)(),
                                { blockId: c } = (0, o.N)();
                            return (0, i.useMemo)(() => ({ pageId: null != t ? t : a, blockId: null != r ? r : c, pageEntityId: null != n ? n : s }), [r, c, t, n, a, s]);
                        })(e),
                        r = ((e) => {
                        ...
                        a = ((e) => {
                            let { pageId: t, blockId: r, pageEntityId: o, contextType: l, contextId: a, utmForPageIds: _ } = e,
                                p = (0, n.useSearchParams)();
                            return (0, i.useMemo)(
                                () =>
                                    ((e) => {
                                        let { searchParams: t, pageId: r, pageEntityId: i, utmForPageIds: o, contextId: l, contextType: n, blockId: a } = e,
                                        ...
                                        return !p || !_ || !i || u.includes(a)
                                            ? null
                                            : (Array.isArray(o) ? o.map((e) => String(e)).includes(String(i)) : !!l && p === n && String(l) === String(i)) && _
                                              ? (0, d.Z)(_)
                                              : null;
                                    })({ searchParams: p, pageId: t, pageEntityId: o, utmForPageIds: _, contextId: a, contextType: l, blockId: r }),
                                [p, t, o, a, l, r, _],
                            );
                        })({
                            ...t,
                    ...
                    return (0, i.useMemo)(() => ({ from: r, utmLink: a || void 0 }), [r, a]);
                };
        },
        73325: (e, t, r) => {
            'use strict';
        ...
        78176: (e, t, r) => {
            ...
            let C = (0, l.PA)((e) => {
                let { artist: t, className: r } = e,
                    ...
                    S = (0, c.c)((e) => {
                        (l.modal.isOpened && l.modal.close(), g({ to: a.AppScreen.ArtistScreen }), x(e));
                    });
                return (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsxs)(u.Dr, {
        ...
        78648: (e, t, r) => {
            ...
            let l = (e) => {
                ...
                a = (e) => {
                    if (!(e instanceof i.m5) || !(0, o.N)(e.cause)) return 'unexpected';
                    let t = ((e) => {
        ...
        89083: (e, t, r) => {
            ...
            let i = [
                ...
                o = (e) =>
                    i.reduce((t, r) => {
                        let { queryKey: i, resultKey: o } = r;
                        return ('string' == typeof e[i] && (t[o] = e[i]), t);
                    }, {});
        },
        90006: (e) => {
        ...
        90326: (e, t, r) => {
            ...
            let _ = (0, o.PA)((e) => {
                    let {
                        ...
                        R = ''.concat(_ ? 'pause' : 'play').concat('filled' === l ? '_filled' : ''),
                        L = _ ? a.S7.PAUSE_BUTTON : a.S7.PLAY_BUTTON,
                        N = b(_ ? { id: 'player-actions.pause' } : { id: 'player-actions.play' }),
                        j = (0, s.c)((e) => {
                            (e.stopPropagation(), e.preventDefault(), null == p || p(e), T && O(!_));
                        });
                    return (0, i.jsx)(c.$, {
                        className: r,
                        variant: x,
        ...
        94218: (e, t, r) => {
            ...
            var i = r(32290),
                ...
                _ = r(34186);
            let p = (e) => {
                let { size: t = 'm', variant: r = 'default', color: p = 'primary', withRipple: m = !0, buttonText: f, isBlock: v, key: x, className: h } = e,
                    C = (0, o.useRouter)(),
                    g = (0, _.N)().get(u.QG),
                    y = (0, a.c)(() => {
                        g.authorizationUrl && ((0, d.uV)({ stage: 'attempt-start', trigger: 'user' }), C.push(g.authorizationUrl));
                    });
                return (0, i.jsx)(
                    s.$,
                    {
                        ...
                        children: f || (0, i.jsx)(c.HL, { variant: 'div', size: 'l', lineClamp: 1, children: (0, i.jsx)(l.A, { id: 'authorization.enter-button' }) }),
                    },
                    x,
                );
            };
            ...
            let x = [
                ...
                h = () => {
                    let e = (0, i.useRef)(!1),
                        ...
                        { offsetBlockPosY: E } = (0, _.u)(),
                        { blockId: A, blockType: I, blockPosX: T, blockPosY: O, mainObjectType: b, mainObjectId: R, objectsCount: L } = (0, u.N)(),
                        { filterKey: N, filterValue: j, filterPos: P } = (0, p.G)(),
                        { skeleton: k } = (0, f.b)(),
                        w = (0, a.L)(() => (void 0 !== E && void 0 !== O ? E + O : O));
                    return (0, i.useCallback)(() => {
                        if (!t || !C || !d.xK.includes(C) || !x.includes(C) || e.current) return;
                        let i = { hash: h, pageId: c.F[C], entityType: I, entityId: A, entityPosX: T, entityPosY: w, objectsCount: L };
                        (void 0 !== N && ((i.filterKey = N), (i.filterValue = j), (i.filterPos = P)),
                            d.qG.includes(C) && ((i.tabId = g), (i.tabPos = y), (i.isTabSelectedByDefault = S)),
                            k && (i.skeletonId = k),
                            R && b && ((i.mainObjectType = b), (i.mainObjectId = R)));
                        let n = (0, o.F)({ params: i, logger: r, context: 'useSendEventOnBlockLoaded' });
                        n && ((0, l.uY)(t.evgenInstance, n), (e.current = !0));
                    }, [t, C, h, I, A, T, w, N, j, P, L, k, R, b, r, g, y, S]);
                };
        },
        96299: (e) => {
            e.exports = {
        ...
        97841: (e, t, r) => {
            ...
            let c = (e, t, r) => {
                ...
                d = (e) => {
                    let { formatMessage: t, language: r, tld: i, year: o } = e;
                    return {
                        year: o,
                        yandexMusic: { id: s.YANDEX, title: t({ id: 'footer.yandex-music' }), url: c(s.YANDEX, i, r) },
                        yandexProjects: { id: s.YANDEX_PROJECTS, title: t({ id: 'footer.yandex-project' }), url: c(s.YANDEX_PROJECTS, i, r) },
                    };
                };
            var u = r(15559),
                _ = r(8626);
            ...
            let y = (e) => {
                            ...
                            (0, i.jsx)('ol', {
                                ...
                                children: r.map((e) => {
                                    ...
                                    return (0, i.jsx)(
                                        ...
                                        {
                                            className: x().item,
                                            children: (0, i.jsx)(g.N, { target: '_blank', href: o, className: x().link, 'data-test-id': h.S7.FOOTER_LINK, children: r }),
                                        },
                                        t,
                                    );
                                }),
                ...
                E = (e) => {
                    ...
                    return (0, i.jsxs)('footer', {
                        ...
                        children: [(0, i.jsx)(S, { links: r.links, disclaimer: r.disclaimer }), (0, i.jsx)(y, { data: r.copyrights })],
                    });
                };
            (0, l.PA)((e) => {
                let { className: t } = e,
                    { location: r } = (0, f.g)(),
                    { formatDate: o, formatMessage: l } = (0, n.A)(),
                    { language: a } = (0, m.h)(),
                    s = d({ formatMessage: l, language: a, tld: r.tld, year: p(o) });
                return (0, i.jsx)(y, { className: t, data: s });
            });
            let A = (0, l.PA)((e) => {
                var t;
                let { className: r } = e,
                    { experiments: l, location: _, user: v } = (0, f.g)(),
                    { formatDate: h, formatMessage: C } = (0, n.A)(),
                    { isEnabled: g } = null != (t = (0, a.P)()) ? t : {},
                    { language: y } = (0, m.h)(),
                    S = ((e) => {
                        let { checkExperiment: t, formatMessage: r, isWebApplication: i, language: o, tld: l, userRegion: n, year: a } = e;
                        return {
                            links: ((e) => {
                                let { formatMessage: t, isWebApplication: r, tld: i, language: o, userRegion: l } = e,
                                    n = { id: s.COPYRIGHT_HOLDER, title: t({ id: 'footer.links-copyright-holders' }), url: c(s.COPYRIGHT_HOLDER, i, o) },
                                    a = { id: s.PRIVACY_POLICY, title: t({ id: 'footer.links-privacy-policy' }), url: c(s.PRIVACY_POLICY, i, o) },
                                    d = { id: s.AGREEMENT, title: t({ id: 'footer.links-terms' }), url: c(s.AGREEMENT, i, o) },
                                    u = { id: s.RECOMMENDATION_RULES, title: t({ id: 'footer.links-recommendation-rules' }), url: c(s.RECOMMENDATION_RULES, i, o) },
                                    _ = { id: s.HELP, title: t({ id: 'footer.links-help' }), url: c(s.HELP, i, o) },
                                    p = [n, d, u];
                                return (r && 'ru' === l && p.push(a), p.push(_), p);
                            })({ formatMessage: r, isWebApplication: i, language: o, tld: l, userRegion: n }),
                            disclaimer: (0, u.v)({
                                checkExperiment: t,
                            ...
                            copyrights: d({ formatMessage: r, language: o, tld: l, year: a }),
                        };
                    })({
                ...
                return (0, i.jsx)(E, { className: (0, o.$)({ [x().root_withOffsetForDeeplink]: g }, r), data: S });
            });
        },
        99872: (e, t, r) => {
            'use strict';
    ...
    (e) => {
        (e.O(
            0,
            [
                7412, 1010, 1256, 7475, 2147, 8461, 5108, 3608, 2690, 6706, 5472, 8378, 900, 2536, 2146, 3353, 2474, 8035, 347, 2732, 1410, 229, 7307, 8506, 6050, 5806,
                7702, 6874, 9155, 4668, 9740, 1175, 4942, 4220, 9562, 7358,
            ],
            () => e((e.s = 41878)),
        ),
            (_N_E = e.O()));
