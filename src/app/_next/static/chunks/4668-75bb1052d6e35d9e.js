        ...
        98740: (e, t, r) => {
            ...
            let N = (e) => {
                let { storeName: t, place: r, communicationId: c, campaignId: f, customTarget: p, offerElement: v, isEnabled: g = !0 } = e,
                    ...
                    m = (0, l.N)(),
                    b = (0, o.j)().page,
                    { getIsShimmerVisible: E, getIsShimmerActive: O, getOffer: h, getTarget: N, serviceSessionId: A } = y(t, g, c, f, p),
                    P = N(b, r),
                    {
                        mainText: I,
                        mainTextA11y: M,
                    ...
                    { offersShown: q, offersClicked: K } = S(g),
                    X = (0, a.useCallback)(() => {
                        g && D && q({ serviceSessionId: A, offersBatchId: D, offersPositionId: R, position: w, page: b, place: k });
                    }, [g, q, A, D, R, w, b, k]),
                    J = (0, a.useCallback)(() => {
                        g && D && K({ serviceSessionId: A, offersBatchId: D, offersPositionId: R, page: b, place: k, offerPosition: w });
                    }, [g, K, A, D, R, b, k, w]),
                    Z = (0, a.useRef)(!1),
                    $ = (0, a.useRef)(!1),
                    Q = (0, a.useCallback)(() => {
                        (($.current = !0), (Z.current = !1), D && (X(), (Z.current = !0)));
                    }, [D, X]);
                ((0, a.useEffect)(() => {
                    $.current && D && !Z.current && (X(), (Z.current = !0));
                }, [D, X]),
                    ((e) => {
                        var t;
                    ...
                    })({ offerElement: v, isEnabled: g, onShow: Q }),
                    ((e) => {
                    ...
                    })({ offerElement: v, isEnabled: g, onClick: J }));
                ...
                return (0, a.useMemo)(
                    ...
                    [L, H, Y, G, I, M, J, X, U, B, V, F, ee, et, W, j, z],
                );
            };
        },
    },
