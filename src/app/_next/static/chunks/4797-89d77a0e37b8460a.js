    ...
    [4797],
    {
        ...
        8946: (e, t, r) => {
            ...
            let u = (e) => {
                    let { isActive: t } = e;
                    return (0, o.jsxs)('div', {
                        className: (0, a.$)(d().root, d().root_withCovers),
                        children: [
                            (0, o.jsx)(c.E, { width: 36 }),
                            (0, o.jsxs)('div', {
                                className: d().lines,
                                children: [
                                    (0, o.jsx)(s.W, { isActive: t, width: 98, className: d().title }),
                                    (0, o.jsx)(s.W, { isActive: t, width: 85, className: d().subtitle }),
                                ],
                            }),
                        ],
                    });
                ...
                C = (e) => {
                    ...
                    return (0, o.jsx)('div', {
                        className: (0, a.$)(d().root, r),
                        children: (0, o.jsx)('div', { className: d().lines, children: (0, o.jsx)(s.W, { isActive: t, width: 78, className: d().title }) }),
                    });
                };
            var m = r(4340),
                A = r.n(m);
            let f = (e) => {
                    let { isShimmerVisible: t, value: r, shimmer: i, children: n, onTabChange: s, className: c, elementId: _, forwardRef: d, ...u } = e;
                    return t && i ? i : (0, o.jsx)(l.tU, { className: (0, a.$)(A().root, c), value: r, elementId: _, onTabChange: s, ref: d, ...u, children: n });
                },
                B = (e) => {
                ...
                E = (e) => {
                    ...
                    return (0, o.jsx)('div', { className: (0, a.$)(A().root, t), children: Array.from({ length: i }, (e, t) => (0, o.jsx)(u, { isActive: r }, t)) });
                },
            ...
            var o,
                ...
                n = {
                        ...
                        let a = r(4377),
                            ...
                            c = (e) => {
                                let {
                                    ...
                                    j = 'left' === o,
                                    O = null,
                                    P = (0, i.isValidElement)(m);
                                if (C) {
                                    var M, N;
                                    O = (0, i.cloneElement)(C, {
                                        className: (0, n.clsx)(
                                            s.default.icon,
                                            {
                                                [s.default['icon_position_'.concat(o)]]: o && !w,
                                                [s.default.icon_withButtonSize]: !(null == (M = C.props) ? void 0 : M.size),
                                            },
                                            null == (N = C.props) ? void 0 : N.className,
                                            x,
                                        ),
                                        key: R,
                                    });
                                }
                                let L = (0, i.useMemo)(() => (P ? (0, a.jsx)('div', { className: s.default.spinnerContainer, children: m }) : null), [P, m]),
                                    k = (0, i.useCallback)(
                                        (e) => {
                                            if (v) {
                                            ...
                                            P || (p && (0, l.createRipple)(e, s.default.ripple), null == f || f(e));
                                        },
                                        [v, P, f, p],
                                    );
                                return (0, a.jsx)('button', {
                                    ...
                                    className: (0, n.clsx)(
                                        s.default.root,
                                        s.default['root_'.concat(d, '_').concat(F)],
                                        s.default['root_radius_'.concat(B)],
                                        s.default.root_size,
                                        {
                                            [s.default['root_'.concat(d, '_withHover_').concat(F)]]: b && !v && !P,
                                            [s.default['root_size_'.concat(E)]]: E,
                                            [s.default.root_withoutBorder]: !h,
                                            [s.default.root_withActiveSpinner]: P,
                                            [s.default.block]: r,
                                            [s.default.flexIcon]: u,
                                            [s.default.iconOnly]: w,
                                            [s.default.root_icon_left]: C && !w && j,
                                            [s.default.root_icon_right]: C && !w && !j,
                                        },
                                        _,
                                    ),
                                    type: D,
                                    ...
                                    children:
                                        C || P
                                            ? (0, a.jsxs)('span', {
                                                  className: (0, n.clsx)(s.default.contentContainer, { [s.default.contentContainer_block]: r }, S),
                                                  children: [C && j && O, !w && c, C && !j && O, L],
                                              })
                                            : c,
                                });
                            };
                    ...
                    8889: function (e, t, r) {
                        ...
                        let s = (e) => {
                            let { className: t, variant: r = 'default', value: o, disabled: s, onTabChange: c, children: _, forwardRef: d, elementId: u = '', ...C } = e;
                            return (0, a.jsx)('ol', {
                                ...
                                ...C,
                                children:
                                    _ && n.Children.map(_, (e) => (0, n.cloneElement)(e, { onTabChange: c, active: e.props.value === o, disabled: s, elementId: u })),
                            });
                        };
            ...
            let m = (e) => {
                let {
                    ...
                    b = (0, i.useMemo)(
                        () =>
                            E
                                ? (0, o.jsx)(c.DZ, { className: (0, a.$)(C().title, f), variant: 'div', size: 'xs', weight: 'bold', lineClamp: 1, children: u })
                                : (0, o.jsx)(c.HL, {
                ...
                return (0, o.jsxs)(s.oz, {
                    ...
                    className: (0, a.$)(
                        C().root,
                        { [C().tab_size_s]: !D && B, [C().tab_size_m]: !D && !B, [C().tab_withCovers]: B, [C().tab_withMissingCovers]: B && !A },
                        t,
                    ),
                    'data-test-id': n.S7.TAB,
                    ...p,
                    children: [h, (0, o.jsxs)('span', { className: C().description, children: [b, v] })],
                });
            };
        },
        53394: (e) => {
