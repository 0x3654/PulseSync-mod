...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2176, 3266, 6989, 7307],
    {
                ...
                function e(t, n, a, u) {
                    ...
                    if (
                        ...
                        (this.formatToParts = function (e) {
                            return (function e(t, n, r, o, a, u, c) {
                                if (1 === t.length && (0, l.isLiteralElement)(t[0])) return [{ type: s.literal, value: t[0].value }];
                                for (var h = [], m = 0; m < t.length; m++) {
                                    var d = t[m];
                                    if ((0, l.isLiteralElement)(d)) {
                                        h.push({ type: s.literal, value: d.value });
                                        continue;
                                    }
                                    if ((0, l.isPoundElement)(d)) {
                                        'number' == typeof u && h.push({ type: s.literal, value: r.getNumberFormat(n).format(u) });
                                        continue;
                                    }
                                    var y = d.value;
                                    if (!(a && y in a)) throw new v(y, c);
                                    var b = a[y];
                                    if ((0, l.isArgumentElement)(d)) {
                                        ((b && 'string' != typeof b && 'number' != typeof b) || (b = 'string' == typeof b || 'number' == typeof b ? String(b) : ''),
                                            h.push({ type: 'string' == typeof b ? s.literal : s.object, value: b }));
                                        continue;
                                    }
                                    if ((0, l.isDateElement)(d)) {
                                        var E = 'string' == typeof d.style ? o.date[d.style] : (0, l.isDateTimeSkeleton)(d.style) ? d.style.parsedOptions : void 0;
                                        h.push({ type: s.literal, value: r.getDateTimeFormat(n, E).format(b) });
                                        continue;
                                    }
                                    if ((0, l.isTimeElement)(d)) {
                                        var E = 'string' == typeof d.style ? o.time[d.style] : (0, l.isDateTimeSkeleton)(d.style) ? d.style.parsedOptions : o.time.medium;
                                        h.push({ type: s.literal, value: r.getDateTimeFormat(n, E).format(b) });
                                        continue;
                                    }
                                    if ((0, l.isNumberElement)(d)) {
                                        var E = 'string' == typeof d.style ? o.number[d.style] : (0, l.isNumberSkeleton)(d.style) ? d.style.parsedOptions : void 0;
                                        (E && E.scale && (b *= E.scale || 1), h.push({ type: s.literal, value: r.getNumberFormat(n, E).format(b) }));
                                        continue;
                                    }
                                    if ((0, l.isTagElement)(d)) {
                                        var S = d.children,
                                            _ = d.value,
                                            T = a[_];
                                        if ('function' != typeof T) throw new g(_, 'function', c);
                                        var I = T(
                                    ...
                                    if ((0, l.isSelectElement)(d)) {
                                        var w = d.options[b] || d.options.other;
                                        if (!w) throw new p(d.value, b, Object.keys(d.options), c);
                                        h.push.apply(h, e(w.value, n, r, o, a));
                                        continue;
                                    }
                                    if ((0, l.isPluralElement)(d)) {
                                        ...
                                        if (!w) {
                                            ...
                                            var O = r.getPluralRules(n, { type: d.pluralType }).select(b - (d.offset || 0));
                                            w = d.options[O] || d.options.other;
                                        }
                                        if (!w) throw new p(d.value, b, Object.keys(d.options), c);
                                        h.push.apply(h, e(w.value, n, r, o, a, b - (d.offset || 0)));
                                        continue;
                                    }
                                }
                                return h.length < 2
                    ...
                    ((this.formats =
                        ...
                        (this.formatters =
                            (u && u.formatters) ||
                            (void 0 === (h = this.formatterCache) && (h = { number: {}, dateTime: {}, pluralRules: {} }),
                            {
                                getNumberFormat: o(
                                    function () {
                                    ...
                                    { cache: y(h.number), strategy: d.variadic },
                                ),
                                getDateTimeFormat: o(
                                    function () {
                                        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                    ...
                                    { cache: y(h.dateTime), strategy: d.variadic },
                                ),
                                getPluralRules: o(
                                    function () {
                                        for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                    ...
                                    { cache: y(h.pluralRules), strategy: d.variadic },
                                ),
                            })));
                }
                return (
        ...
        17408: (e, t, n) => {
            ((t.TV = function (e, t) {
                let { skeletonId: n = '', mainObjectType: r = s.DomainObjectType.NonApplicable, mainObjectId: l = '' } = t,
                    o = (0, i.makeMetaParams)(1),
                    a = { ...t, skeletonId: n, mainObjectType: r, mainObjectId: l, _meta: o };
        ...
        28470: (e, t, n) => {
            var i;
            ((t.HB = function (e, t) {
                let { objectsCount: n = 1, objectPosX: i = 1, objectPosY: r = 1 } = t,
                    l = (0, s.makeMetaParams)(2),
                    o = {
                        ...t,
                        objectsCount: n,
                        objectPosX: i,
        ...
        37456: (e, t, n) => {
            ((t.__ = function (e, t) {
                let n = (0, i.makeMetaParams)(1),
                    s = { ...t, pageId: 'artist_concerts_screen', pageType: 'listing', _meta: n };
                e.trackEvent('ArtistConcerts.Opened', s);
            }),
                (t.pe = function (e, t) {
                    let n = (0, i.makeMetaParams)(1),
                        s = { ...t, pageId: 'artist_concerts_screen', pageType: 'listing', _meta: n };
                    e.trackEvent('ArtistConcerts.Closed', s);
                }),
                (t.Z4 = function (e, t) {
                    let { objectPos: n = 1 } = t,
                        s = (0, i.makeMetaParams)(1),
                        r = { ...t, objectPos: n, pageId: 'artist_concerts_screen', pageType: 'listing', objectType: 'concert', _meta: s };
                    e.trackEvent('ArtistConcerts.Concert.Showed', r);
                }),
                (t.mh = function (e, t) {
                    let { objectPos: n = 1 } = t,
                        s = (0, i.makeMetaParams)(1),
                    ...
                    e.trackEvent('ArtistConcerts.Concert.Navigated', r);
                }));
            let i = n(92871);
        },
        63670: (e, t, n) => {
        ...
        77307: (e, t, n) => {
            ...
            function r(e, t, n) {
                ...
                function r() {
                    ...
                    let h = e();
                    if (!(h.length !== s.length || h.some((e, t) => s[t] !== e))) return i;
                    if (
                        ((s = h),
                        n.key && (null == (l = n.debug) ? void 0 : l.call(n)) && (c = Date.now()),
                        (i = t(...h)),
                            ...
                            ({ count: e, paddingStart: t, scrollMargin: n, getItemKey: i, enabled: s }, r) => {
                                ...
                                for (let s = l; s < e; s++) {
                                    let e = i(s),
                                        ...
                                        u = r.get(e),
                                        c = 'number' == typeof u ? u : this.options.estimateSize(s),
                                        h = a + c,
                                        m = l ? l.lane : s % this.options.lanes;
                                    o[s] = { index: s, start: a, size: c, end: h, key: e, lane: m };
                                }
            ...
            function T(e) {
                return _({ observeElementRect: c, observeElementOffset: f, scrollToFn: y, ...e });
            }
            function I(e) {
                return _({
