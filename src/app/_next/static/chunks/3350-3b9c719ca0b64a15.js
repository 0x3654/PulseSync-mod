    ...
    [3350],
    {
        ...
        41898: (e, t, a) => {
            ...
            let f = (e) => {
                let { children: t, title: a, className: n } = e,
                    { setTitleElement: i, setTitle: l } = (0, o.useContext)(p.B),
                    s = (0, o.useRef)(null);
                return (
                    (0, o.useEffect)(() => {
            ...
            let L = (0, i.PA)((e) => {
                let {
                    ...
                    z = (0, o.useMemo)(
                        () =>
                            N
                                ? { font: b().font_mobile, iconLink: b().arrowWrapper_mobile }
                                : M
                                  ? { font: b().font_long, iconLink: b().arrowWrapper_long }
                                  : { font: b().font_short, iconLink: b().arrowWrapper_short },
                        [N, M],
                    ),
                    O = !N && i && A,
                    W = (0, o.useCallback)(() => {
                        var e;
                        (E(!0), null == (e = B.current) || e.focus());
                    }, []),
                    I = (0, o.useCallback)(
                        (e) => {
                            (E(!1), null == p || p(e));
                    ...
                    S = (0, c.L)(() =>
                        (0, r.jsx)('span', {
                            className: (0, n.$)(b().arrowWrapper, z.iconLink),
                            children: (0, r.jsx)(u.I, { className: b().titleWithLinkIcon, size: 'xs', variant: 'arrowRight' }),
                        }),
                    ),
                    U = (0, c.L)(() =>
                        (0, r.jsxs)(g.DZ, {
                            variant: j,
                            id: a,
                            lineClamp: N && k ? 2 : void 0,
                            className: (0, n.$)(b().heading, { [b().heading_withVersion]: L }),
                            'data-test-id': s.e8.pageHeader.ENTITY_TITLE,
                            children: [
                                (0, r.jsx)(g.HL, { className: (0, n.$)(b().font, z.font, b().title), variant: 'span', children: t }),
                                L &&
                                    (0, r.jsx)(g.HL, {
                                        onClick: w,
                                        className: (0, n.$)(b().font, z.font, b().version, { [b().version_withOtherVersions]: w }),
                                        variant: 'span',
                    ...
                    F = (0, c.L)(() =>
                        H
                            ? (0, r.jsxs)(x.N, {
                                  className: b().titleWithLink,
                                  containerClassName: b().linkContainer,
                                  textClassName: b().linkText,
                                  href: H,
                                  onClick: D,
                                  children: [U, N && S],
                              })
                    ...
                    children: [
                        !O &&
                            (0, r.jsxs)('div', {
                                ...
                                children: [
                                    (0, r.jsx)(f, { title: t, className: b().stickyTitle, children: F }),
                                    i &&
                                        (0, r.jsx)('div', {
                                            className: (0, n.$)(b().editButton, { [b().editButton_centered]: !M && !N }),
                                            children: (0, r.jsx)(_.$, {
                                                onClick: W,
                        ...
                        O &&
                            (0, r.jsx)('div', {
                                className: b().textFieldContainer,
                                children: (0, r.jsx)(v.A, {
                                    text: t,
                                    className: (0, n.$)(b().font, z.font, b().textField, b().title, { [b().textField_long]: M && !N }),
                                    onChangeFinish: I,
                                    maxTextLength: y,
                                    minTextLength: 1,
        ...
        73395: (e, t, a) => {
            ...
            function p(e) {
                ...
                var a = (g[e] = { exports: {} });
                return (u[e].call(a.exports, a, a.exports, p), a.exports);
            }
            ((p.d = (e, t) => {
                for (var a in t) p.o(t, a) && !p.o(e, a) && Object.defineProperty(e, a, { enumerable: !0, get: t[a] });
            }),
            ...
            var f = {};
            (() => {
                (Object.defineProperty(f, '__esModule', { value: !0 }), (f.Label = void 0));
                var e = p(2018);
            ...
            var m = a(71926),
                ...
                C = a.n(H),
                N = a(41898);
            let P = 'entity-header-block-controls',
                A = (0, i.PA)((e) => {
                    let {
                            'aria-labelledby': t,
                            entityName: a,
                            ...
                            logo: I,
                            coverCellClassName: S,
                            infoClassName: U,
                            linkTitle: F,
                            onTitleLinkClick: V,
                            showMobileLoginButton: Y,
                            showMobileSubscriptionButton: Z,
                        } = e,
                        [$, K] = (0, c.d)(),
                        {
                            experiments: Q,
                            settings: { browserInfo: G },
                        } = (0, L.g)(),
                        J = G.isMobile && (Q.checkExperiment(w.z.WebNextFreeToApp, 'on') || Q.checkExperiment(w.z.WebNextFreeToApp, 'on-unauthorized')),
                        X = G.isMobile && Q.checkExperiment(w.z.WebNextFreeToApp, 'on-unauthorized'),
                        {
                            ...
                            isShimmerActive: ea,
                            isShimmerVisible: er,
                            oneClickAvailable: en,
                            oneClickDisclaimerText: ei,
                            oneClickDisclaimerTextA11y: eo,
                        } = (0, b.D)({ storeName: 'music', isEnabled: !!Z && !J, offerElement: { element: $, intersectionPropertyId: P } }),
                        el = (0, o.useMemo)(
                            () =>
                                E
                                    ? (0, r.jsx)('div', {
                                          className: C().entityContainer,
                                          children: (0, r.jsx)(h, {
                                              size: 'm',
                                              className: C().disclaimerLabel,
                    ...
                    return (0, r.jsxs)('div', {
                        className: (0, n.$)(
                            C().root,
                            { [C().root_withCover]: (0, o.isValidElement)(y), [C().root_withCoverAndLogo]: (0, o.isValidElement)(I) && (0, o.isValidElement)(y) },
                            g,
                        ),
                        ref: p,
                        'data-test-id': d.e8.pageHeader.ENTITY_HEADER,
                        children: [
                            y && (0, r.jsx)('div', { className: (0, n.$)(C().coverCell, S), children: y }),
                            (0, r.jsxs)('div', {
                                className: (0, n.$)(C().content, z),
                                children: [
                                    (0, r.jsxs)('div', {
                                        className: (0, n.$)(C().info, U),
                                        children: [
                                            el,
                                            (0, r.jsx)(N.R, {
                                                onTitleLinkClick: V,
                                                link: F,
                                                className: (0, n.$)(C().title, R, { [C().title_withDisclaimerLabel]: !!E }),
                                                title: i,
                                                'aria-labelledby': t,
                                                canChange: f,
                                                maxTitleLength: x,
                                            ...
                                            !!l && (0, r.jsx)('div', { className: (0, n.$)(C().meta, { [C().meta_withDisclaimerLabel]: !!E }, D), children: l }),
                                        ],
                                    }),
                                    (0, r.jsx)('div', { className: C().controls, 'data-test-id': d.e8.pageHeader.BASE_PAGE_HEADER_CONTROLS, children: u }),
                                    Y &&
                                        (0, r.jsxs)('div', {
                                            ...
                                            children: [
                                                X &&
                                                    (0, r.jsx)(T.O, {
                                                        isBlock: !0,
                                                        className: C().button,
                                                        buttonText: (0, r.jsx)(m.HL, {
                                                            variant: 'div',
                                                            size: 'm',
                                                            lineClamp: 1,
                                                            children: (0, r.jsx)(s.A, { id: 'download-mobile-app.listen-in-app-without-restrictions' }),
                                                        }),
                                                    }),
                                                (0, r.jsx)(k.H, {
                                                    size: 'l',
                                                ...
                                                !X &&
                                                    (0, r.jsxs)(m.HL, {
                                                        ...
                                                        size: 'm',
                                                        weight: 'medium',
                                                        className: C().bonusText,
                                                        children: [
                                                            (0, r.jsx)(_.I, { variant: 'gift', size: 'xxs', className: C().giftIcon }),
                                    ...
                                    Z &&
                                        (0, r.jsx)('div', {
                                            className: C().buttonContainer,
                                            children: J
                                                ? (0, r.jsx)(T.O, { isBlock: !0, className: C().button })
                                                : (0, r.jsxs)(r.Fragment, {
                                                      children: [
                                                          (0, r.jsx)(j.b, {
                                                              mainText: ee,
                                                          ...
                                                          en &&
                                                              (0, r.jsx)(m.HL, {
                                                                  ...
                                                                  weight: 'normal',
                                                                  'aria-label': eo,
                                                                  className: C().oneClickDisclaimerText,
                            ...
                            (0, o.isValidElement)(I) && (0, r.jsx)('div', { className: C().logo, children: I }),
                        ],
                    });
                }),
                E = (0, o.forwardRef)((e, t) =>
                    (0, r.jsx)(x.r, { page: v.l.ENTITY_HEADER, places: [y.R.BOTTOM_BUTTON], children: (0, r.jsx)(A, { forwardRef: t, ...e }) }),
                );
        },
        73422: (e, t, a) => {
            'use strict';
