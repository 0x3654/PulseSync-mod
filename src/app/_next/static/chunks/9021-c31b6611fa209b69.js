        ...
        24535: (e, t, n) => {
            ...
            function a(e) {
                let { ogTitle: t, ogDescription: n, fullUrl: a, locale: l, ogImage: o, siteName: s, ogType: c, customImage: u } = e,
                    g = o ? { url: (0, r.createAvatarUrl)(o, 1e3, !0), width: 1e3, height: 1e3 } : void 0;
                return {
                    title: t,
                    description: n,
                    url: a,
        ...
        64170: (e, t, n) => {
            ...
            let A = (0, a.PA)((e) => {
                let { className: t, withBackwardControl: n = !0 } = e,
                    ...
                    S = a({ id: 'error-messages.something-went-wrong' });
                !(function (e) {
                    let t = (0, y.st)(),
                        { hash: n } = (0, y.gf)(),
                        { pageId: r } = (0, f.$)(),
                ...
                return (0, r.jsxs)('div', {
                    ...
                    children: [
                        n &&
                            (0, r.jsx)(E.L, { withBackwardFallback: '/', className: (0, i.$)(w().navigation, { [w().navigation_desktop]: !L }), withForwardControl: !1 }),
                        (0, r.jsxs)('div', {
                            className: (0, i.$)(w().content, { [w().content_shrink]: !n }),
                            children: [
                                (0, r.jsx)(u.I, { className: w().icon, variant: 'attention', size: 'xxl' }),
                                (0, r.jsx)(g.DZ, { className: (0, i.$)(w().title, w().important), variant: 'h3', size: 'xs', children: S }),
                                (0, r.jsxs)(g.HL, {
                                    className: (0, i.$)(w().text, w().important),
                                    variant: 'span',
                                    type: 'text',
                                    size: 'l',
                                    weight: 'normal',
