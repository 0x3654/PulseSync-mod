    ...
    [7165],
    {
        ...
        7748: (e, t, n) => {
            ...
            var l = n(32290),
                ...
                x = n.n(S);
            let A = (0, o.PA)((e) => {
                let { className: t, title: n, description: o, iconVariant: S = 'musicLogo', iconClassName: A, iconSize: F } = e,
                    { contentRef: E, setContentScrollRef: T } = (0, P.g)(),
                    j = (0, b.Z)(N.Z.main.href);
                !(function () {
                    let e = (0, g.st)(),
                        { hash: t } = (0, g.gf)(),
                        n = (0, v.U)(),
                ...
                return (
                    ...
                    (0, l.jsxs)(i.N, {
                        className: (0, a.$)(x().root, { [x().root_desktop]: !E }, t),
                        containerClassName: x().container,
                        ref: T,
                        children: [
                            (0, l.jsx)(h.L, { withBackwardFallback: '/', className: x().navigation, withForwardControl: !1 }),
                            (0, l.jsxs)('div', {
                                className: x().content,
                                children: [
                                    (0, l.jsx)(s.I, { className: (0, a.$)(x().icon, A), variant: S, size: F }),
                                    (0, l.jsx)(u.DZ, {
                                        className: (0, a.$)(x().title, x().important),
                                        variant: 'h3',
                                        size: 'xs',
        ...
        12894: (e, t, n) => {
            ...
            let g = (0, o.PA)((e) => {
                let {
                    ...
                    { canBack: P, canForward: N, moveBack: b, moveForward: k } = (0, p.J)(g),
                    h = (0, r.useRef)(null),
                    _ = (0, i.c)((e) => {
                        (e.stopPropagation(), b());
                    }),
