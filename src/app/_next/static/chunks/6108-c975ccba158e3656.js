            ...
            function N(e) {
                ...
                var eh = (0, o.__read)((0, s.useState)(!0), 2),
                    ...
                    e_ = (0, s.useMemo)(
                        ...
                        [eS, W, ee, et, en, I, eo, eC, eb, B, U, z],
                    );
                (0, s.useEffect)(
                    function () {
                        !eb && (Q || j) && ey(!0);
                ...
                ((eT.current = eB),
                    ...
                    (0, s.useEffect)(
                        function () {
                            eB({ methodCall: 'updateTheme', params: [{ colorScheme: I, theme: eo }] });
                        },
                        [I, eB, eo],
                    ));
                ...
                return {
                    avatarProps: { avatarSize: eL, env: B, onClick: eW, onPointerEnter: eN, platform: ek, ref: ef, retpath: eC, userData: eA, visible: eu, tld: em },
                    contentProps: ej,
                    dialogProps: eX,
                };
            }
