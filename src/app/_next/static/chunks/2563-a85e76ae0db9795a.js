        ...
        13798: (e, t, i) => {
            ...
            let v = (0, a.PA)((e) => {
                let { className: t, getDescriptionTexts: i, trackId: a, containerClassName: p, variant: v, size: A = 'xxxs', ...x } = e,
                    ...
                    f = (0, n.useMemo)(() => C({ id: 'extra-explicit.explicit-mark' }), [C]);
                (0, n.useEffect)(() => {
                    i && i().then(k);
                }, [i, a]);
        ...
        21105: (e, t, i) => {
            ...
            let $ = (0, s.PA)((e) => {
                ...
                let ef = (0, a.useMemo)(() => {
                    ...
                    eS = (0, a.useMemo)(() => {
                        if (!s.isNonMusic) return (0, r.jsx)(H.C, { onClick: ek, disabled: !s.isAvailable || (ep && Z), variant: M.I.ALBUM, onOpenMenuChange: P });
                    }, [s.isAvailable, ek, s.isNonMusic, P, ep, Z]),
                    eT = { variant: O.Y.ALBUM, id: s.id, title: s.title, path: eA, albumArtistName: s.artistName, albumArtistId: s.artistId };
                return (0, r.jsxs)(u.W1, {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(U.H, { shareLink: ev, entityMeta: eT }),
                    ],
                });
            });
        },
        ...
        24170: (e, t, i) => {
            ...
            let Q = (0, a.PA)((e) => {
                let {
                    ...
                    { ref: es, intersectionPropertyId: ea } = (0, T.n)(),
                    {
                        user: en,
                        trailer: el,
                    ...
                    eJ = (0, x.c)({ album: a, callback: eT }),
                    eX = (0, x.c)({ album: a, callback: eY }),
                    eq = (0, _.c)((e) => {
                        (ef({ to: o.AppScreen.AlbumScreen }), null == ev || ev(), eJ(e));
                    }),
                    eZ = (0, _.c)(() => {
                        if (!ew()) {
                    ...
                    e7 = (0, n.useMemo)(() => {
                        var e;
                        return (0, r.jsx)(W.N, { href: a.url, onClick: eq, children: ''.concat(a.title, ' ').concat(null != (e = a.version) ? e : '') });
                    ...
                    e8 = (0, n.useMemo)(() => {
                        if (!eD)
                            return (0, r.jsx)(
                                H.O,
                                { onClick: eS, isPinned: a.isPinned, className: (0, s.$)(Z().pinButton, Z().control), withRipple: !1, isDisabled: eD },
                                a.getKey('PinButton'),
                            );
                    }, [a, eD, eS]),
                    e4 = (0, n.useMemo)(() => {
        ...
        41677: (e, t, i) => {
            ...
            let k = (0, a.PA)((e) => {
                    let {
                        ...
                        T = ((e) => {
                            ...
                            artist: t,
                            callback: (0, h.c)((e) => {
                                (f && N.isOpened && N.close(), y(e));
                            }),
                        }),
                        L = (0, h.c)((e) => {
                            (S({ to: m.AppScreen.ArtistScreen }), null == j || j(), T(e));
                        });
                    return i && !t.various
                        ? (0, r.jsx)(b.N, {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [
                        ...
                        (0, r.jsx)(y.N, {
                            ...
                            children: (0, r.jsx)(f.A, { id: 'entity-names.number-of-more-artists', values: { counter: t } }),
                        }),
                    ],
                });
            };
            ...
            let B = (0, a.PA)((e) => {
                ...
                U = (0, a.PA)((e) => {
                    ...
                    return y ? (0, r.jsx)(D, { labelRef: S, artists: i, label: z }) : z;
                });
        },
        47977: (e) => {
            e.exports = {
