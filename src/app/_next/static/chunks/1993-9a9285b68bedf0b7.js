                        ...
                        let i = r(4377),
                            ...
                            u = (e) => {
                                let {
                                        ...
                                        'aria-disabled': x,
                                        iconClassName: S,
                                        contentContainerClassName: z,
                                        ...q
                                    } = e,
                                    R = (0, o.useId)(),
                                    g = !o.Children.toArray(u).filter(Boolean).length,
                                    j = 'left' === a,
                                    O = null,
                                    T = (0, o.isValidElement)(A);
                                if (E) {
                                    var L, P;
                                    O = (0, o.cloneElement)(E, {
                                        className: (0, l.clsx)(
                                            s.default.icon,
                                            {
                                                [s.default['icon_position_'.concat(a)]]: a && !g,
                                                [s.default.icon_withButtonSize]: !(null == (L = E.props) ? void 0 : L.size),
                                            },
                                            null == (P = E.props) ? void 0 : P.className,
                                            S,
                                        ),
                                        key: R,
                                    });
                                }
                                let N = (0, o.useMemo)(() => (T ? (0, i.jsx)('div', { className: s.default.spinnerContainer, children: A }) : null), [T, A]),
                                    k = (0, o.useCallback)(
                                        (e) => {
                                            if (h) {
                                            ...
                                            T || (F && (0, n.createRipple)(e, s.default.ripple), null == f || f(e));
                                        },
                                        [h, T, f, F],
                                    );
                                return (0, i.jsx)('button', {
                                    ...
                                    className: (0, l.clsx)(
                                        ...
                                        s.default.root_size,
                                        {
                                            [s.default['root_'.concat(_, '_withHover_').concat(D)]]: b && !h && !T,
                                            ...
                                            [s.default.root_icon_left]: E && !g && j,
                                            [s.default.root_icon_right]: E && !g && !j,
                                        },
                                        d,
                                    ),
                                    type: B,
                                    ...
                                    children:
                                        E || T
                                            ? (0, i.jsxs)('span', {
                                                  className: (0, l.clsx)(s.default.contentContainer, { [s.default.contentContainer_block]: r }, z),
                                                  children: [E && j && O, !g && u, E && !j && O, N],
                                              })
                                            : u,
                                });
                            };
