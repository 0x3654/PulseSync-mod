                    ...
                    6372: function (e, t, r) {
                        ...
                        t.MenuComponent = (e) => {
                            let {
                                ...
                                ee = (0, i.useRef)([]),
                                et = (0, i.useRef)([]),
                                er = (0, i.useContext)(u.MenuContext),
                                en = (0, o.useFloatingTree)(),
                                es = (0, o.useFloatingNodeId)(),
                                ea = (0, o.useFloatingParentNodeId)(),
                                eo = (0, o.useListItem)(),
                                ei = null !== ea,
                                {
                                    floatingStyles: el,
                                ...
                                { isMounted: ef, styles: ed } = (0, o.useTransitionStyles)(eu, N),
                                ex = (0, o.useHover)(eu, {
                                    enabled: (ei || v) && !E,
                                    delay: { open: 75 },
                                ...
                                ep = (0, o.useClick)(eu, { enabled: !E, event: 'mousedown', keyboardHandlers: !0, toggle: !ei, ignoreMouse: ei }),
                                e_ = (0, o.useRole)(eu, { role: H }),
                                ev = (0, o.useDismiss)(eu, U),
                                em = (0, o.useListNavigation)(eu, { listRef: ee, activeIndex: J, nested: ei, onNavigate: $ }),
                                eg = (0, o.useTypeahead)(eu, { listRef: et, onMatch: Z ? $ : void 0, activeIndex: J }),
                                { getReferenceProps: eE, getFloatingProps: ek, getItemProps: ey } = (0, o.useInteractions)([ex, ep, e_, ev, em, eg]);
                            ((0, i.useEffect)(() => {
                                if (en)
                                    return (
                                        en.events.on('click', e),
                                        en.events.on('menuopen', t),
                                        () => {
                                            (en.events.off('click', e), en.events.off('menuopen', t));
                                        }
                                    );
                                function e() {
                                    G(!1);
                                ...
                                function t(e) {
                                    e.nodeId !== es && e.parentId === ea && G(!1);
                                }
                            }, [en, es, ea, G]),
                                (0, i.useEffect)(() => {
                                    Z && en && en.events.emit('menuopen', { parentId: ea, nodeId: es });
                                }, [en, Z, es, ea]),
                                (0, i.useEffect)(() => {
                                    Z && (null == y || y());
                                }, [y, Z]));
                            let eb = (0, i.useCallback)((e) => {
                                    e.stopPropagation();
                                }, []),
                            ...
                            return (0, s.jsx)(o.FloatingNode, {
                                ...
                                children: (0, s.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, s.jsxs)(c.Button, {
                                            ...K,
                                            ref: (0, o.useMergeRefs)([ec.setReference, eo.ref, D]),
                                            tabIndex: ei ? (er.activeIndex === eo.index ? 0 : -1) : void 0,
                                            role: ei ? 'menuitem' : void 0,
                                            'data-open': Z ? '' : void 0,
                                            'data-nested': ei ? '' : void 0,
                                            'data-focus-inside': Q ? '' : void 0,
                                            className: (0, a.clsx)(
                                                { [p.default.menuItem]: ei, [p.default.rootMenu]: !ei, [p.default.rootMenu_onlyIcon]: !ei && 'text' === k },
                                                t,
                                            ),
                                            icon: _,
                                            size: m,
                                            radius: g,
                                            withRipple: !ei && C,
                                            iconClassName: ei ? p.default.icon : p.default.rootIcon,
                                            variant: ei ? void 0 : k,
                                            'aria-label': ei ? void 0 : O,
                                            disabled: E,
                                            ...eE(
                                                er.getItemProps({
                                                    ...K,
                                                    onFocus(e) {
                                                        var t;
                                                        (null == (t = K.onFocus) || t.call(K, e), X(!1), er.setHasFocusInside(!0));
                                                    },
                                                }),
                                            ),
                                            children: [
                                        ...
                                        (0, s.jsx)(u.MenuContext.Provider, {
                                            value: { activeIndex: J, setActiveIndex: $, getItemProps: ey, setHasFocusInside: X, isOpen: Z },
