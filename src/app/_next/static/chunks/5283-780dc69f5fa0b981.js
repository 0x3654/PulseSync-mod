    ...
    [5283],
    {
        ...
        38777: (e, i, t) => {
            ...
            var r = t(60754),
                ...
                g = t(45346),
                c = t(56e3);
            let m = [n.S.MUSIC, n.S.TRACK, n.S.NOISE, n.S.ASMR],
                y = r.gK
                    .compose(
                    ...
                    .views((e) => {
                        let i = {
                            ...
                            get isAvailableForDownload() {
                                if (!(0, r._n)(e)) return !1;
                                return (e.type && m.includes(e.type)) || !!i.isUGC;
                            },
                            getUrl(i) {
        ...
        75819: (e, i, t) => {
            ...
            let l = (e, i) => {
                ...
                let { isSmartPreview: v, hasEverFinished: b } = i || {},
                    ...
                    _ = v ? (null == (t = e.smartPreviewParams) ? void 0 : t.durationMs) : null == e ? void 0 : e.durationMs,
                    f = (0, n.wg)({ available: !!(null == (l = e.specialAudioResources) ? void 0 : l.includes(r.SMART_PREVIEW)) });
                return (0, n.wg)({
                    id: (e.id || 0).toString(),
