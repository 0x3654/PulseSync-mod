        ...
        57367: (e, t, r) => {
            ...
            let v = i.gK
                    ...
                    .views((e) => ({
                        ...
                        getDisclaimerEntityRef: (t) => ({ entityType: null != t ? t : s.n.ARTIST, entityId: e.id }),
                    }))
                    .actions((e) => ({
                        toggleLike: (0, i.L3)(function* () {
                            if (!(0, i._n)(e)) return;
                            let { library: t, user: r } = (0, o.M)(e);
                            if (r.isAuthorized) {
                        ...
                        togglePin: (0, i.L3)(function* () {
                            if (!(0, i._n)(e)) return;
                            let { pinsCollection: t, user: r } = (0, o.M)(e);
            ...
            let b = n.gK
                ...
                .views((e) => {
                    let t = {
                        ...
                        get pinId() {
                            return ''.concat(o._.ALBUM_ITEM).concat(e.id);
                        },
                        get seeds() {
                        ...
                        get shouldShowBooksBadge() {
                            ...
                            return !!(
                                ...
                                (!e.availableForPremiumUsers && (null == (s = e.availableForOptions) ? void 0 : s.includes(i.BOOKMATE)))
                            );
                        },
                ...
                .actions((e) => ({
                    toggleLike: (0, n.L3)(function* () {
                        ...
                        if (r.isAuthorized) {
                            ...
                            return ((0, n._n)(e) && i === s.f.OK && (e.isLiked ? e.likePending() : e.unlikePending()), i);
                        }
                    }),
                        ...
                        if ('string' == typeof r && 'object' == typeof l) {
                            ...
                            t.push(
                                (0, i.wg)({
                                    ...
                                    separator: r,
                                    isAvailable: null == (o = l.available) || o,
