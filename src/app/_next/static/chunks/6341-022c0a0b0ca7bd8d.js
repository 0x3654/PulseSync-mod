    ...
    [6341],
    {
                    ...
                    let { track: t, closeToast: i, withLink: s } = e,
                        l = ((e) => {
                            switch (e.type) {
                                case f.S.PODCAST:
                                case f.S.AUDIOBOOK:
                                    return T.Z.collectionShelfLiked.href;
                                default:
                                    return T.Z.collection.href;
                            }
                        })(t),
                        r = (0, A.b)(t);
                    return (0, a.jsx)(x.O, {
                    ...
                    let { user: t, fullscreenPlayer: i } = (0, o.g)(),
                        ...
                        A = (() => {
                            ...
                            return (0, l.c)(async (s) => {
                                ...
                                y &&
                                    (f === _.f.OK
                                        ? e((0, a.jsx)(I, { withLink: n, track: A }), { containerId: u })
        ...
        39400: (e, t, i) => {
            ...
            let eO = (0, r.PA)((e) => {
                ...
                eN = (0, r.PA)((e) => {
                    var t, i, r, eu, e_, ev, ep, ey, ex, eA, ef, eT, eI, eh, eE, eC, eN, eb, eg, eS;
                    let {
                            track: ej,
                            onOpenChange: eL,
                            open: eD,
                        ...
                        eq = (0, O.e)(),
                        {
                            ...
                            user: e1,
                            slam: e9,
                            albumCPA: { isPlusCPAPlayerBarEnabled: e5 },
                        } = (0, N.g)(),
                        { formatMessage: e3 } = (0, o.A)(),
                        { sendLikeSearchFeedback: e4 } = (0, Y.z)(),
                        [e6, e8] = (0, n.useState)(!1),
                        { modal: te } = eJ,
                        { modal: tt } = e0,
                        { modal: ti } = eW,
                        ta = (function (e) {
                            ...
                            return (0, n.useMemo)(() => {
                                ...
                                return v
                                    ? (0, R.t)({ contextType: L.K.Album, contextId: v, entityContextType: m })
                                    : (null == (i = s.meta) ? void 0 : i.uid) && (null == (n = s.meta) ? void 0 : n.kind)
                                      ...
                                      : a.id
                                        ? (0, R.t)({ contextType: L.K.Album, contextId: a.id, entityContextType: m })
                                        : l.id
                                          ? (0, R.t)({ contextType: L.K.Artist, contextId: l.id, entityContextType: m })
                                          : (null == e ? void 0 : e.albumId)
                                            ? (0, R.t)({ contextType: L.K.Album, contextId: e.albumId, entityContextType: m })
                                            : (0, R.t)({ contextType: L.K.Various, contextId: null != (d = null == e ? void 0 : e.id) ? d : '', entityContextType: m });
                            }, [
                                o,
                                c,
                                r.isOpened,
                        ...
                        ts = (0, j.i)(ej, I.N.NEXT, ta),
                        tl = (0, j.i)(ej, I.N.LAST, ta),
                        tr = (0, S.K)(ej),
                        tn = (0, g.m)(ej),
                        to = (0, y.K)(ej.mainAlbum),
                        tc = ((e) => {
                            let {
                                    user: t,
                                    fullscreenPlayer: i,
                            ...
                            return (0, _.c)(async () => {
                                if (!e) return;
                                let o = i.modal.isOpened ? E.u.FULLSCREEN_ERROR : E.u.ERROR;
                                if (!t.isAuthorized)
                        ...
                        td = (0, z.F)(),
                        tu = ''.concat(B.U.TRACK, '-').concat(ej.id),
                        tm = eP || eV.isMobile,
                        t_ = '/album/:albumId/track/:trackId';
                    ej.albumId || (t_ = '/track/:trackId');
                    let { shareLink: tv, pathname: tp } = (0, $.b)(t_, { params: { albumId: null != (eg = ej.albumId) ? eg : '', trackId: ej.id } }),
                        ty = ej.isUGC ? V.D.UGC_TRACK : V.D.TRACK,
                        tx = (0, f.A)({ entityVariant: ty, urlParams: { id: ej.id } }),
                        tA = ((e) => {
                            var t;
                        ...
                        tf = (0, x.C)(),
                        tT = !!(null == (t = ej.mainAlbum) ? void 0 : t.isNonMusic),
                        tI = (null == eQ ? void 0 : eQ.id) === ej.id && (null == eQ ? void 0 : eQ.albumId) === (null == (i = ej.mainAlbum) ? void 0 : i.id),
                        tk =
                            (null == e7 || null == (r = e7.meta) ? void 0 : r.listeningFinished) ||
                            (tI && (null == eQ || null == (eu = eQ.streamProgress) ? void 0 : eu.hasEverFinished)) ||
                            (null == (e_ = ej.streamProgress) ? void 0 : e_.hasEverFinished),
                        th = e1.hasPlus && ej.isAvailableForDownload,
                        tE = eX.checkExperiment(W.z.WebEditorsFeatures, 'on'),
                        tC = eX.checkExperiment(W.z.WebNextTrackComplaintForm, 'on') && ej.isTrackMusic,
                        tO = !!(0, m.S)(null == eq ? void 0 : eq.state.currentContext.value),
                        { canRemoveTrackFromPlaylist: tN, removeTrackFromPlaylist: tb } = (0, er.s)(),
                        tg = (0, w.P)(),
                        tS = e5(null == (ev = ej.mainAlbum) ? void 0 : ev.id, null == (ep = ej.mainAlbum) ? void 0 : ep.isNonMusic),
                        { isPlaying: tj, togglePlay: tL } = (0, q.B)({
                        ...
                        tD = (0, _.c)(async () => {
                            (e6 || ej.isLiked || (e8(!0), null == e4 || e4()), await tr());
                        }),
                        tR = (0, _.c)(() => {
                        ...
                        tP = (0, _.c)(() => {
                            if (eY && !tS) return void eH();
                            tg() || (e$.setUtmLink(eK), e$.openTrackTrailer(ej.entityId), td(d.DomainObjectType.Track, ej.id));
                        }),
                        tM = (0, _.c)(() => {
                            var e;
                            (eW.setTrack({ id: ej.id, albumId: (null == (e = ej.mainAlbum) ? void 0 : e.id) || null, isUGC: ej.isUGC || null }),
                                e2.isOpened && e2.close(),
                                ti.open());
                        }),
                        tU = (0, _.c)(() => {
                            ej.clipIds && tf((0, l.HO)(ej.clipIds));
                        }),
                        tK = (0, _.c)(() => {
                            if (eY && e1.isAuthorized) return void eH();
                            (e0.setTrack(ej), e2.isOpened && e2.close(), tt.open());
                        }),
                        tw = (0, _.c)(() => {
                            if (eY && e1.isAuthorized) return void eH();
                        ...
                        tz = (0, _.c)(() => {
                            (eJ.setTrackId(ej.id), e2.isOpened && e2.close(), te.open(), null == eL || eL(!1));
                        }),
                        tF = (0, _.c)(() => ej.isSyncLyricsAvailable && eG.modal.isOpened && tm),
                        tY = (0, _.c)(() => ej.isLyricsAvailable && !eG.modal.isOpened),
                        tH = (0, _.c)(() => {
                            var e;
                            return (null == (e = ej.trailer) ? void 0 : e.isAvailable) && !eG.modal.isOpened && ez;
                        }),
                        {
                            withSyncLyricsItem: tq,
                            withLyricsItem: tV,
                            withTrailerItem: tW,
                        } = (0, n.useMemo)(
                            () => ({ withSyncLyricsItem: tF(), withLyricsItem: tY(), withTrailerItem: tH() }),
                            [tF, tY, tH, ej.isSyncLyricsAvailable, ej.isLyricsAvailable, null == (ex = ej.trailer) ? void 0 : ex.isAvailable],
                        );
                    (0, H.N)(eD);
                    let tX = !tT,
                        tG = ej.isNonUserGenerated && !tT,
                        t$ = !tT,
                        tQ = !tm,
                        tZ = tT && to,
                        tJ = ej.isNonUserGenerated && (ej.albums.length || ej.mainAlbum),
                        t0 =
                            ej.isNonUserGenerated &&
                            !!(null == (eA = ej.artists) ? void 0 : eA.length) &&
                            ((null == (ef = ej.mainAlbum) ? void 0 : ef.isAudiobook) ||
                                (null == (eT = ej.mainAlbum) ? void 0 : eT.isAlbum) ||
                                ej.isTrackAudiobook ||
                                ej.isTrackMusic),
                        t7 = !tO && eQ,
                        t2 = eG.isPlayQueueMode && ew && !eZ,
                        t1 = (0, A.d)() && ej.isNonUserGenerated && (null == (eI = ej.clipIds) ? void 0 : eI.length),
                        t9 = {
                            variant: X.Y.TRACK,
                            id: ej.id,
                            title: ej.title,
                            ...
                            trackArtistId: null == (eE = ej.mainArtist) ? void 0 : eE.id,
                            trackAlbumId: ej.albumId,
                        };
                    return e9.isOfflineModeEnabled
                        ? (0, a.jsxs)(p.W1, {
                              isMobile: tm,
                              placement: eR,
                              offsetOptions: 10,
                              ...
                              variant: 'text',
                              ...eF,
                              children: [th && (0, a.jsx)(ek, { track: ej }), ej.isNonUserGenerated && (0, a.jsx)(ee.H, { shareLink: tv, entityMeta: t9 })],
                          })
                        : (0, a.jsxs)(p.W1, {
                              dismissSettings: eB,
                              isMobile: tm,
                              ...
                              children: [
                                  (0, a.jsx)(eO, { track: ej }),
                                  tm && (0, a.jsx)(el.C, { getDescriptionTexts: ej.getDescriptionTexts, entityId: ej.id }),
                                  tE && (0, a.jsx)(T.d, { entityVariant: ty, adminUrl: tx }),
                                  tT && (0, a.jsx)(ei, { onClick: tc, isFinished: tk }),
                                  tX && (0, a.jsx)(Z.T, { onClick: tD, isLiked: ej.isLiked, disabled: !e1.isAuthorized }),
                                  tW && (0, a.jsx)(ea.N, { onClick: tP }),
                                  tG && (0, a.jsx)(es.C, { onClick: tR, variant: G.I.TRACK, disabled: !ej.isAvailable || (tS && tm), onOpenMenuChange: eL }),
                                  t1 &&
                                      (0, a.jsx)(p.Dr, {
                                          onClick: tU,
                                  ...
                                  t$ && (0, a.jsx)(Q.D, { onClick: tn, isDisliked: ej.isDisliked }),
                                  tQ && (0, a.jsx)(ed.$, { track: ej }),
                                  tV &&
                                      (0, a.jsx)(p.Dr, {
                                          disabled: !e1.isAuthorized,
                                          onClick: tK,
                                  ...
                                  ej.isNonUserGenerated && (0, a.jsx)(ee.H, { shareLink: tv, entityMeta: t9 }),
                                  tJ &&
                                      (null == (eC = ej.mainAlbum) ? void 0 : eC.url) &&
                                      (0, a.jsx)(J.f, { albumUrl: ej.mainAlbum.url, albumType: ej.mainAlbum.type, trackType: ej.type }),
                                  t0 && ej.artists[0] && (0, a.jsx)(ec.o, { artists: ej.artists }),
                                  tZ &&
                                      (0, a.jsx)(et.U, {
                                          onClick: to,
                                          isLiked: null == (eN = ej.mainAlbum) ? void 0 : eN.isLiked,
                                          albumType: null == (eb = ej.mainAlbum) ? void 0 : eb.type,
                                      }),
        ...
        40229: (e, t, i) => {
            ...
            let x = (0, l.PA)((e) => {
                    ...
                    return (0, a.jsx)('div', {
                        className: (0, s.$)(y().root, t, { [y().root_disabled]: !i, [y().root_current]: f, [y().root_disliked]: l && !C, [y().root_playing]: A }),
        ...
        56117: (e, t, i) => {
            ...
            let K = (0, s.PA)((e) => {
                ...
                return (0, a.jsx)(g.$, {
                    closeToast: o,
                    message: m,
                    cover: (0, a.jsx)(R.B, { className: U().image, src: s, withAvatarReplace: !0, size: 100, fit: 'cover', alt: t }),
                    coverRadius: 's',
                });
            });
            var w = i(54950),
                ...
                Q = (0, s.PA)((e) => {
                    ...
                    let b = (0, l.useMemo)(() => {
                        ...
                        g = (0, h.L)(() => {
                            ...
                            if (0 !== e.length)
                                return e.map((e, t) => {
                                    if (!e || e.kind === E.j.LIKE) return;
                                    let i = O + 1 === T && t === p.items.length - (p.items.length % 20);
                        ...
                        children: [
                            ...
                            (0, a.jsxs)('div', {
                                ...
                                children: [
                                    ...
                                    (0, a.jsx)(W, {
                                        className: (0, I.$)({ [G().shimmerEndItem]: O + 1 === T }),
                                        ref: A,
            ...
            let E = () => {
                let { notify: e } = (0, h.l)(),
                    ...
                    c = (0, s.c)((s) => {
                        ...
                        if (n) {
                            let t = (0, I.e)(d);
                            e((0, a.jsx)(T, { entityTitle: d.title, entityVariant: t, entityCoverUri: null != (r = d.coverUri) ? r : '', playlist: c }), {
        ...
        75783: (e, t, i) => {
            ...
            let O = (e) => {
                ...
                return (0, a.jsx)(I.$, {
                    className: (0, x.$)(C().root, o),
                    closeToast: n,
                    message: (0, a.jsxs)('div', {
                        className: C().message,
                        children: [
                            (0, a.jsx)(f.q, { children: (0, a.jsx)('p', { role: 'alert', 'aria-label': t }) }),
                            (0, a.jsx)(A.t, {
                                className: C().cover,
                                radius: 's',
                                children: (0, a.jsx)(h.B, { className: C().image, src: i, alt: s, size: 100, fit: 'cover', withAvatarReplace: !0 }),
                            }),
                            (0, a.jsx)(T.HL, { className: C().text, variant: 'div', type: 'controls', size: 'm', 'aria-hidden': !0, children: t }),
                        ],
                    }),
                });
            };
        ...
        84141: (e, t, i) => {
            ...
            let c = (e) => {
                let { track: t, withSavingQueryParams: i, entityType: c, onNavigate: d } = e,
                    ...
                    T = (0, s.l)({ ...A, callback: x });
                return (0, l.C)({ onClick: f, onCmdCtrlClick: T });
            };
        },
        84427: (e, t, i) => {
            'use strict';
