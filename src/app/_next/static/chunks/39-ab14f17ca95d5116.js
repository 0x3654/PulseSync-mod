...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    {
        4628: (t, e, a) => {
            a.d(e, { P7: () => y, ZZ: () => A, r1: () => f, SU: () => l, xd: () => k, ET: () => I, PP: () => w, vW: () => T });
            var s,
                i = a(91945),
                o = a(71695),
                r = a(68413);
            ...
            let T = (t) => !!(t && 'object' == typeof t && 'source' in t);
            class y {
                get isNeededToLoad() {
                ...
                async load() {
                    ...
                    try {
                        (T(this.data.dataFromSkeleton) && (await this.loadMetadata()),
                ...
                constructor({ data: t, hooksEmitter: e }) {
                    ((0, i._)(this, 'data', void 0),
                        ...
                        (this.data = t),
                        (this.hooksEmitter = e),
                        (this.state = new _({ loadingStatus: o.rl.IDLE, visibilityStatus: o.zE.HIDDEN })));
                }
            }
            var b = a(99424);
            let w = (t) => {
        ...
        70039: (t, e, a) => {
            ...
            class y extends u {
                loadingStatusChangeHandler() {
                    if (this.data.meta && this.state.loadingStatus.value === _.rl.RESOLVE) for (let t of this.data.meta.newReleases) this.items.push(new T(t));
                }
