...
> [!TIP]
> - 🎵 **Нотч-плеер** — капсула в зоне меню-бара: трек, прогресс, громкость колесом над артом, поиск, кража нативного меню трека (macOS)
> - 🪟 **macOS-тайтлбар** — кнопки мода в шапке, pulseText на плашке
> - 📦 **Прямой установщик dev-сборок** — `curl | bash`
...
- macOS (Windows/Linux — в разработке)
- `python3` и `shasum` (входят в macOS)
